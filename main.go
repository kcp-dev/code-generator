...
//go:generate go run ../helpgen/main.go paths=../../pkg/... generate:headerFile=../../boilerplate.go.txt,year=2022
...
func main() {
	...
	cmd := &cobra.Command{
		...
		Example: `	# Generate listers and informers for all types under apis/,
	# outputting listers to /tmp/listers and everything else to stdout
	code-generator lister informers paths=./apis/... output:listers:dir=/tmp/listers output:stdout

	# Generate deepcopy/runtime.Object implementations for a particular file
	code-generator object paths=./apis/v1beta1/some_types.go

	# Generate OpenAPI v3 schemas for API packages and merge them into existing CRD manifests
	code-generator schemapatch:manifests=./manifests output:dir=./manifests paths=./pkg/apis/... 

	# Run all the generators for a given project
	code-generator paths=./apis/...
