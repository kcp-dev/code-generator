...
// or scope down to one cluster and return a exampledashedv2client.ClusterTestTypeInterface.
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) exampledashedv2client.ClusterTestTypeInterface
	List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv2.ClusterTestTypeList, error)
...
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) exampledashedv2client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv2.ClusterTestTypeList, error) {
