...
type TestTypeInformer interface {
	...
	Lister() exampledashedv2listers.TestTypeLister
}
...
func (f *testTypeInformer) Lister() exampledashedv2listers.TestTypeLister {
	return f.lister
}
...
func (f *testTypeScopedInformer) Lister() exampledashedv2listers.TestTypeLister {
	return exampledashedv2listers.NewTestTypeLister(f.Informer().GetIndexer())
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleDashedV2().TestTypes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
