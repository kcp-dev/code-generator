...
import (
	...
	scopedclientset "acme.corp/pkg/generated/clientsetv2/versioned"
	clientset "acme.corp/pkg/kcp/clientsv2/exampledashed/versioned"
	"acme.corp/pkg/kcp/clientsv2/informers/externalversions/internalinterfaces"
	exampledashedv2listers "acme.corp/pkg/kcp/clientsv2/listers/exampledashed/v2"
)
...
type ClusterTestTypeInformer interface {
	...
	Lister() exampledashedv2listers.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() exampledashedv2listers.ClusterTestTypeLister {
	return f.lister
}
...
func (f *clusterTestTypeScopedInformer) Lister() exampledashedv2listers.ClusterTestTypeLister {
	return exampledashedv2listers.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
