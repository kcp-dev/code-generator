...
type TestTypeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*somegroup2v1.TestType, error)
...
// List lists all TestTypes in the indexer for a workspace.
func (s *testTypeScopedLister) List(selector labels.Selector) (ret []*somegroup2v1.TestType, err error) {
...
// List lists all TestTypes in the indexer for a given workspace and namespace.
func (s *testTypeScopedNamespaceLister) List(selector labels.Selector) (ret []*somegroup2v1.TestType, err error) {
...
// Get retrieves the TestType from the indexer for a given workspace, namespace and name.
func (s *testTypeScopedNamespaceLister) Get(name string) (*somegroup2v1.TestType, error) {
