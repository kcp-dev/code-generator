...
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) secondexamplev1client.ClusterTestTypeInterface
...
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) secondexamplev1client.ClusterTestTypeInterface {
