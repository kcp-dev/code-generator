...
// TestTypesNamespacer can scope to objects within a namespace, returning a exampledashedv1client.TestTypeInterface.
type TestTypesNamespacer interface {
	Namespace(string) exampledashedv1client.TestTypeInterface
}
