...
// or scope down to one cluster and return a exampledashedv1client.ClusterTestTypeInterface.
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) exampledashedv1client.ClusterTestTypeInterface
...
type clusterTestTypesClusterInterface struct {
	clientCache kcpclient.Cache[*exampledashedv1client.ExampleDashedV1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) exampledashedv1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv1.ClusterTestTypeList, error) {
