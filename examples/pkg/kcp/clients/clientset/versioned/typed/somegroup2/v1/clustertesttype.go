...
// or scope down to one cluster and return a somegroup2v1client.ClusterTestTypeInterface.
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) somegroup2v1client.ClusterTestTypeInterface
	List(ctx context.Context, opts metav1.ListOptions) (*somegroup2v1.ClusterTestTypeList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
}

type clusterTestTypesClusterInterface struct {
	clientCache kcpclient.Cache[*somegroup2v1client.Somegroup2V1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) somegroup2v1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*somegroup2v1.ClusterTestTypeList, error) {
