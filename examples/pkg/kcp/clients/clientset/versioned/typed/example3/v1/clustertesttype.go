...
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) example3v1client.ClusterTestTypeInterface
...
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) example3v1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*example3v1.ClusterTestTypeList, error) {
