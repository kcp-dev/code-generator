...
func (c *clusterTestTypesClusterClient) Cluster(clusterPath logicalcluster.Path) example3v1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClient) Create(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts metav1.CreateOptions) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(clusterTestTypesResource, c.ClusterPath, clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterTestTypesClient) Update(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts metav1.UpdateOptions) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(clusterTestTypesResource, c.ClusterPath, clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *clusterTestTypesClient) UpdateStatus(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts metav1.UpdateOptions) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(clusterTestTypesResource, c.ClusterPath, "status", clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *clusterTestTypesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(clusterTestTypesResource, c.ClusterPath, name, opts), &example3v1.ClusterTestType{})
	return err
}
...
func (c *clusterTestTypesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(clusterTestTypesResource, c.ClusterPath, name), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *clusterTestTypesClient) List(ctx context.Context, opts metav1.ListOptions) (*example3v1.ClusterTestTypeList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(clusterTestTypesResource, clusterTestTypesKind, c.ClusterPath, opts), &example3v1.ClusterTestTypeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterTestTypesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, name, pt, data, subresources...), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *clusterTestTypesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsexample3v1.ClusterTestTypeApplyConfiguration, opts metav1.ApplyOptions) (*example3v1.ClusterTestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, *name, types.ApplyPatchType, data), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *clusterTestTypesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsexample3v1.ClusterTestTypeApplyConfiguration, opts metav1.ApplyOptions) (*example3v1.ClusterTestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, *name, types.ApplyPatchType, data, "status"), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
