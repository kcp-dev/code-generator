...
func (c *ExampleV1alpha1ClusterClient) Cluster(cluster logicalcluster.Name) examplev1alpha1.ExampleV1alpha1Interface {
	if cluster == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}
	return &ExampleV1alpha1Client{Fake: c.Fake, Cluster: cluster}
}
