...
type ClusterTestTypeInformer interface {
	...
	Lister() secondexamplev1listers.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() secondexamplev1listers.ClusterTestTypeLister {
	return f.lister
}
...
func (f *clusterTestTypeScopedInformer) Lister() secondexamplev1listers.ClusterTestTypeLister {
	return secondexamplev1listers.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
