...
func (f *clusterTestTypeClusterInformer) Lister() secondexamplev1.ClusterTestTypeClusterLister {
	return secondexamplev1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() secondexamplev1.ClusterTestTypeLister {
