...
type TestTypeInformer interface {
	...
	Lister() somegroup2v1listers.TestTypeLister
}
...
func (f *testTypeInformer) Lister() somegroup2v1listers.TestTypeLister {
	return f.lister
}
...
func (f *testTypeScopedInformer) Lister() somegroup2v1listers.TestTypeLister {
	return somegroup2v1listers.NewTestTypeLister(f.Informer().GetIndexer())
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.Somegroup2V1().TestTypes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Somegroup2V1().TestTypes(namespace).Watch(context.TODO(), options)
			},
		},
		&somegroup2v1.TestType{},
		resyncPeriod,
