...
func (f *testTypeClusterInformer) Lister() exampledashedv1.TestTypeClusterLister {
	return exampledashedv1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() exampledashedv1.TestTypeLister {
