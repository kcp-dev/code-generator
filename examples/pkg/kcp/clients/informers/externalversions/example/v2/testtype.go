...
func (f *testTypeClusterInformer) Lister() examplev2.TestTypeClusterLister {
	return examplev2.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() examplev2.TestTypeLister {
