...
func (f *clusterTestTypeClusterInformer) Lister() examplev2.ClusterTestTypeClusterLister {
	return examplev2.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev2.ClusterTestTypeLister {
