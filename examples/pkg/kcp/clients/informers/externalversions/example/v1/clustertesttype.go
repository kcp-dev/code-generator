...
func (f *clusterTestTypeClusterInformer) Lister() examplev1.ClusterTestTypeClusterLister {
	return examplev1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev1.ClusterTestTypeLister {
