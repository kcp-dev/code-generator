...
type ClusterTestTypeInformer interface {
	...
	Lister() examplev1listers.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() examplev1listers.ClusterTestTypeLister {
	return f.lister
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev1listers.ClusterTestTypeLister {
	return examplev1listers.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
