...
func (f *testTypeClusterInformer) Lister() examplev1.TestTypeClusterLister {
	return examplev1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() examplev1.TestTypeLister {
