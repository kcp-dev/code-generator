...
func (f *clusterTestTypeClusterInformer) Lister() examplev1alpha1.ClusterTestTypeClusterLister {
	return examplev1alpha1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev1alpha1.ClusterTestTypeLister {
