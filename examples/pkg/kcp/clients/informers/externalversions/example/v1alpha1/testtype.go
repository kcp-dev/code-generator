...
func (f *testTypeClusterInformer) Lister() examplev1alpha1.TestTypeClusterLister {
	return examplev1alpha1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() examplev1alpha1.TestTypeLister {
