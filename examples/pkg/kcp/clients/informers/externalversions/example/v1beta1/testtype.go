...
type TestTypeInformer interface {
	...
	Lister() examplev1beta1listers.TestTypeLister
}
...
func (f *testTypeInformer) Lister() examplev1beta1listers.TestTypeLister {
	return f.lister
}
...
func (f *testTypeScopedInformer) Lister() examplev1beta1listers.TestTypeLister {
	return examplev1beta1listers.NewTestTypeLister(f.Informer().GetIndexer())
}
