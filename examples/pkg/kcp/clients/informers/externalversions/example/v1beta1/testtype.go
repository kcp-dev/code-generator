...
func (f *testTypeClusterInformer) Lister() examplev1beta1.TestTypeClusterLister {
	return examplev1beta1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() examplev1beta1.TestTypeLister {
