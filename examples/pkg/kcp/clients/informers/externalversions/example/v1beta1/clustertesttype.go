...
type ClusterTestTypeInformer interface {
	...
	Lister() examplev1beta1listers.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() examplev1beta1listers.ClusterTestTypeLister {
	return f.lister
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev1beta1listers.ClusterTestTypeLister {
	return examplev1beta1listers.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
