...
func (f *clusterTestTypeClusterInformer) Lister() examplev1beta1.ClusterTestTypeClusterLister {
	return examplev1beta1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() examplev1beta1.ClusterTestTypeLister {
