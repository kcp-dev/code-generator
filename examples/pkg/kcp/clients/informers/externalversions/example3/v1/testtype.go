...
func (f *testTypeClusterInformer) Lister() example3v1.TestTypeClusterLister {
	return example3v1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() example3v1.TestTypeLister {
