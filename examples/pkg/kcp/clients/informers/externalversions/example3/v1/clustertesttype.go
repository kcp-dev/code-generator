...
func (f *clusterTestTypeClusterInformer) Lister() example3v1.ClusterTestTypeClusterLister {
	return example3v1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *clusterTestTypeScopedInformer) Lister() example3v1.ClusterTestTypeLister {
