...
type TestTypeInformer interface {
	...
	Lister() existinginterfacesv1listers.TestTypeLister
}
...
func (f *testTypeInformer) Lister() existinginterfacesv1listers.TestTypeLister {
	return f.lister
}
...
func (f *testTypeScopedInformer) Lister() existinginterfacesv1listers.TestTypeLister {
	return existinginterfacesv1listers.NewTestTypeLister(f.Informer().GetIndexer())
}
