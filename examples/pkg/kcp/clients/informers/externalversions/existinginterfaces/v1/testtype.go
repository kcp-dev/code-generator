...
func (f *testTypeClusterInformer) Lister() existinginterfacesv1.TestTypeClusterLister {
	return existinginterfacesv1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
...
func (f *testTypeScopedInformer) Lister() existinginterfacesv1.TestTypeLister {
