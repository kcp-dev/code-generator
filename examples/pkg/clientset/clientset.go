...
import (
	...
	examplev1client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/example/v1"
	examplev1 "github.com/kcp-dev/code-generator/examples/pkg/generated/clientset/versioned/typed/example/v1"

	examplev2client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/example/v2"
	examplev2 "github.com/kcp-dev/code-generator/examples/pkg/generated/clientset/versioned/typed/example/v2"

	examplev1alpha1client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/example/v1alpha1"
	examplev1alpha1 "github.com/kcp-dev/code-generator/examples/pkg/generated/clientset/versioned/typed/example/v1alpha1"

	examplev1beta1client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/example/v1beta1"
	examplev1beta1 "github.com/kcp-dev/code-generator/examples/pkg/generated/clientset/versioned/typed/example/v1beta1"

	secondexamplev1client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/secondexample/v1"
	secondexamplev1 "github.com/kcp-dev/code-generator/examples/pkg/generated/clientset/versioned/typed/secondexample/v1"

	example3v1client "github.com/kcp-dev/code-generator/examples/pkg/clientset/typed/example3/v1"
