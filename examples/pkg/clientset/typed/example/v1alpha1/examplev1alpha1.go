...
import (
	...
	exampleapiv1alpha1 "github.com/kcp-dev/code-generator/examples/pkg/apis/example/v1alpha1"
...
// WrappedExampleV1alpha1 wraps the client interface with a
// logical cluster.
...
// New creates a WrappedExampleV1alpha1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate examplev1alpha1.ExampleV1alpha1Interface) *WrappedExampleV1alpha1 {
...
// WrappedExampleV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV1alpha1) ClusterTestTypes() examplev1alpha1.ClusterTestTypeInterface {
...
type wrappedClusterTestType struct {
	cluster  logicalcluster.Name
	delegate examplev1alpha1.ClusterTestTypeInterface
}
...
func (w *wrappedClusterTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv1alpha1.ClusterTestType, error) {
...
func (w *wrappedClusterTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv1alpha1.ClusterTestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Create(ctx context.Context, clusterTestType *exampleapiv1alpha1.ClusterTestType, opts metav1.CreateOptions) (*exampleapiv1alpha1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Update(ctx context.Context, clusterTestType *exampleapiv1alpha1.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv1alpha1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) UpdateStatus(ctx context.Context, clusterTestType *exampleapiv1alpha1.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv1alpha1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv1alpha1.ClusterTestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedExampleV1alpha1 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV1alpha1) TestTypes(namespace string) examplev1alpha1.TestTypeInterface {
...
type wrappedTestType struct {
	cluster  logicalcluster.Name
	delegate examplev1alpha1.TestTypeInterface
}
...
func (w *wrappedTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv1alpha1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv1alpha1.TestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Create(ctx context.Context, testType *exampleapiv1alpha1.TestType, opts metav1.CreateOptions) (*exampleapiv1alpha1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Update(ctx context.Context, testType *exampleapiv1alpha1.TestType, opts metav1.UpdateOptions) (*exampleapiv1alpha1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv1alpha1.TestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
