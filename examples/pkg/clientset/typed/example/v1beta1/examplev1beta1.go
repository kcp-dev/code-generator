...
import (
	...
	exampleapiv1beta1 "github.com/kcp-dev/code-generator/examples/pkg/apis/example/v1beta1"
...
// WrappedExampleV1beta1 wraps the client interface with a
// logical cluster.
type WrappedExampleV1beta1 struct {
	cluster  logicalcluster.Name
	delegate examplev1beta1.ExampleV1beta1Interface
}

// New creates a WrappedExampleV1beta1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate examplev1beta1.ExampleV1beta1Interface) *WrappedExampleV1beta1 {
	return &WrappedExampleV1beta1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedExampleV1beta1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedExampleV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV1beta1) ClusterTestTypes() examplev1beta1.ClusterTestTypeInterface {
...
type wrappedClusterTestType struct {
	cluster  logicalcluster.Name
	delegate examplev1beta1.ClusterTestTypeInterface
}
...
func (w *wrappedClusterTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv1beta1.ClusterTestType, error) {
...
func (w *wrappedClusterTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv1beta1.ClusterTestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Create(ctx context.Context, clusterTestType *exampleapiv1beta1.ClusterTestType, opts metav1.CreateOptions) (*exampleapiv1beta1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Update(ctx context.Context, clusterTestType *exampleapiv1beta1.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv1beta1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) UpdateStatus(ctx context.Context, clusterTestType *exampleapiv1beta1.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv1beta1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv1beta1.ClusterTestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedExampleV1beta1 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV1beta1) TestTypes(namespace string) examplev1beta1.TestTypeInterface {
...
type wrappedTestType struct {
	cluster  logicalcluster.Name
	delegate examplev1beta1.TestTypeInterface
}
...
func (w *wrappedTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv1beta1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv1beta1.TestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Create(ctx context.Context, testType *exampleapiv1beta1.TestType, opts metav1.CreateOptions) (*exampleapiv1beta1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Update(ctx context.Context, testType *exampleapiv1beta1.TestType, opts metav1.UpdateOptions) (*exampleapiv1beta1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv1beta1.TestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
