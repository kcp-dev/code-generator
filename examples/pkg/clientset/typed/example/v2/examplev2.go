...
import (
	...
	exampleapiv2 "github.com/kcp-dev/code-generator/examples/pkg/apis/example/v2"
...
// WrappedExampleV2 wraps the client interface with a
// logical cluster.
type WrappedExampleV2 struct {
	cluster  logicalcluster.Name
	delegate examplev2.ExampleV2Interface
}

// New creates a WrappedExampleV2 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate examplev2.ExampleV2Interface) *WrappedExampleV2 {
	return &WrappedExampleV2{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedExampleV2) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedExampleV2 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV2) ClusterTestTypes() examplev2.ClusterTestTypeInterface {
...
type wrappedClusterTestType struct {
	cluster  logicalcluster.Name
	delegate examplev2.ClusterTestTypeInterface
}
...
func (w *wrappedClusterTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv2.ClusterTestType, error) {
...
func (w *wrappedClusterTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv2.ClusterTestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Create(ctx context.Context, clusterTestType *exampleapiv2.ClusterTestType, opts metav1.CreateOptions) (*exampleapiv2.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Update(ctx context.Context, clusterTestType *exampleapiv2.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv2.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) UpdateStatus(ctx context.Context, clusterTestType *exampleapiv2.ClusterTestType, opts metav1.UpdateOptions) (*exampleapiv2.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv2.ClusterTestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedExampleV2 contains the wrapped logical cluster and interface.
func (w *WrappedExampleV2) TestTypes(namespace string) examplev2.TestTypeInterface {
...
type wrappedTestType struct {
	cluster  logicalcluster.Name
	delegate examplev2.TestTypeInterface
}
...
func (w *wrappedTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*exampleapiv2.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) List(ctx context.Context, opts metav1.ListOptions) (*exampleapiv2.TestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Create(ctx context.Context, testType *exampleapiv2.TestType, opts metav1.CreateOptions) (*exampleapiv2.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Update(ctx context.Context, testType *exampleapiv2.TestType, opts metav1.UpdateOptions) (*exampleapiv2.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *exampleapiv2.TestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
