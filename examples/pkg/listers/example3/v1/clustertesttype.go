...
// ClusterTestTypeLister helps list example3v1.ClusterTestType.
// All objects returned here must be treated as read-only.
type ClusterTestTypeClusterLister interface {
	// List lists all example3v1.ClusterTestType in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*example3v1.ClusterTestType, err error)

	// Cluster returns an object that can list and get example3v1.ClusterTestType from the given logical cluster.
...
// Cluster returns an object that can list and get example3v1.ClusterTestType.
...
type ClusterTestTypeLister interface {
	...
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*example3v1.ClusterTestType, err error)
	// Get retrieves the example3v1.ClusterTestType from the indexer for a given name.
	// Objects returned here must be treated as read-only.
