...
// ClusterTestTypeLister helps list examplev1.ClusterTestType.
// All objects returned here must be treated as read-only.
type ClusterTestTypeClusterLister interface {
	// List lists all examplev1.ClusterTestType in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1.ClusterTestType, err error)

	// Cluster returns an object that can list and get examplev1.ClusterTestType from the given logical cluster.
...
// Cluster returns an object that can list and get examplev1.ClusterTestType.
...
type ClusterTestTypeLister interface {
	...
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1.ClusterTestType, err error)
	// Get retrieves the examplev1.ClusterTestType from the indexer for a given name.
	// Objects returned here must be treated as read-only.
