...
// ClusterTestTypeLister helps list examplev1beta1.ClusterTestType.
// All objects returned here must be treated as read-only.
type ClusterTestTypeClusterLister interface {
	// List lists all examplev1beta1.ClusterTestType in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1beta1.ClusterTestType, err error)

	// Cluster returns an object that can list and get examplev1beta1.ClusterTestType from the given logical cluster.
...
// List lists all examplev1beta1.ClusterTestType in the indexer.
func (s *clusterTestTypeClusterLister) List(selector labels.Selector) (ret []*examplev1beta1.ClusterTestType, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*examplev1beta1.ClusterTestType))
	})
	return ret, err
}

// Cluster returns an object that can list and get examplev1beta1.ClusterTestType.
...
type ClusterTestTypeLister interface {
	...
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1beta1.ClusterTestType, err error)
	// Get retrieves the examplev1beta1.ClusterTestType from the indexer for a given name.
	// Objects returned here must be treated as read-only.
...
// Get retrieves the examplev1beta1.ClusterTestType from the indexer for a given name.
func (s clusterTestTypeLister) Get(name string) (*examplev1beta1.ClusterTestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1beta1.Resource("clusterTestType"), name)
	}
	return obj.(*examplev1beta1.ClusterTestType), nil
}
