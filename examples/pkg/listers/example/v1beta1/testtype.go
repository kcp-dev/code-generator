...
// TestTypeLister helps list examplev1beta1.TestType.
// All objects returned here must be treated as read-only.
type TestTypeClusterLister interface {
	// List lists all examplev1beta1.TestType in the indexer.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error)

	// Cluster returns an object that can list and get examplev1beta1.TestType from the given logical cluster.
...
// List lists all examplev1beta1.TestType in the indexer.
func (s *testTypeClusterLister) List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*examplev1beta1.TestType))
	})
	return ret, err
}

// Cluster returns an object that can list and get examplev1beta1.TestType.
...
type TestTypeLister interface {
	...
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error)
	// TestTypes returns an object that can list and get examplev1beta1.TestType.
...
// List lists all examplev1beta1.TestType in the indexer.
func (s *testTypeLister) List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error) {
	...
	for i := range list {
		obj := list[i].(*examplev1beta1.TestType)
		if selectAll {
			ret = append(ret, obj)
		} else {
...
// TestTypeNamespaceLister helps list and get examplev1beta1.TestType.
// All objects returned here must be treated as read-only.
type TestTypeNamespaceLister interface {
	// List lists all examplev1beta1.TestType in the indexer for a given namespace.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error)
	// Get retrieves the examplev1beta1.TestType from the indexer for a given namespace and name.
	// Objects returned here must be treated as read-only.
...
// List lists all examplev1beta1.TestType in the indexer for a given namespace.
func (s testTypeNamespaceLister) List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error) {
	selectAll := selector == nil || selector.Empty()
...
// Get retrieves the examplev1beta1.TestType from the indexer for a given namespace and name.
func (s testTypeNamespaceLister) Get(name string) (*examplev1beta1.TestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1beta1.Resource("testType"), name)
	}
	return obj.(*examplev1beta1.TestType), nil
}
