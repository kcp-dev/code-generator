...
// TestTypeLister helps list examplev1alpha1.TestType.
...
type TestTypeClusterLister interface {
	...
	// Cluster returns an object that can list and get examplev1alpha1.TestType from the given logical cluster.
