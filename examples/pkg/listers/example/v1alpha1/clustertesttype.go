...
// ClusterTestTypeLister helps list examplev1alpha1.ClusterTestType.
...
type ClusterTestTypeClusterLister interface {
	...
	// Cluster returns an object that can list and get examplev1alpha1.ClusterTestType from the given logical cluster.
