...
import (
	...
	example3apiv1 "github.com/kcp-dev/code-generator/examples/pkg/apis/example3/v1"
...
// WrappedExample3V1 wraps the client interface with a
// logical cluster.
type WrappedExample3V1 struct {
	cluster  logicalcluster.Name
	delegate example3v1.Example3V1Interface
}

// New creates a WrappedExample3V1 with the given logical cluster and client interface.
func New(cluster logicalcluster.Name, delegate example3v1.Example3V1Interface) *WrappedExample3V1 {
	return &WrappedExample3V1{cluster: cluster, delegate: delegate}
}

// RESTClient returns the underlying RESTClient.
func (w *WrappedExample3V1) RESTClient() rest.Interface {
	return w.delegate.RESTClient()
}

// WrappedExample3V1 contains the wrapped logical cluster and interface.
func (w *WrappedExample3V1) ClusterTestTypes() example3v1.ClusterTestTypeInterface {
...
type wrappedClusterTestType struct {
	cluster  logicalcluster.Name
	delegate example3v1.ClusterTestTypeInterface
}
...
func (w *wrappedClusterTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*example3apiv1.ClusterTestType, error) {
...
func (w *wrappedClusterTestType) List(ctx context.Context, opts metav1.ListOptions) (*example3apiv1.ClusterTestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Create(ctx context.Context, clusterTestType *example3apiv1.ClusterTestType, opts metav1.CreateOptions) (*example3apiv1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Update(ctx context.Context, clusterTestType *example3apiv1.ClusterTestType, opts metav1.UpdateOptions) (*example3apiv1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) UpdateStatus(ctx context.Context, clusterTestType *example3apiv1.ClusterTestType, opts metav1.UpdateOptions) (*example3apiv1.ClusterTestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedClusterTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *example3apiv1.ClusterTestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
// WrappedExample3V1 contains the wrapped logical cluster and interface.
func (w *WrappedExample3V1) TestTypes(namespace string) example3v1.TestTypeInterface {
...
type wrappedTestType struct {
	cluster  logicalcluster.Name
	delegate example3v1.TestTypeInterface
}
...
func (w *wrappedTestType) Get(ctx context.Context, name string, opts metav1.GetOptions) (*example3apiv1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) List(ctx context.Context, opts metav1.ListOptions) (*example3apiv1.TestTypeList, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Create(ctx context.Context, testType *example3apiv1.TestType, opts metav1.CreateOptions) (*example3apiv1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Update(ctx context.Context, testType *example3apiv1.TestType, opts metav1.UpdateOptions) (*example3apiv1.TestType, error) {
	ctx, err := w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
...
func (w *wrappedTestType) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *example3apiv1.TestType, err error) {
	ctx, err = w.checkCluster(ctx)
	if err != nil {
		return nil, err
	}
