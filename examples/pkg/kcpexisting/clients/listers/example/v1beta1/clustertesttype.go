...
type ClusterTestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) examplev1beta1listers.ClusterTestTypeLister
...
func (s *clusterTestTypeClusterLister) Cluster(clusterName logicalcluster.Name) examplev1beta1listers.ClusterTestTypeLister {
	return &clusterTestTypeLister{indexer: s.indexer, clusterName: clusterName}
}

// clusterTestTypeLister implements the examplev1beta1listers.ClusterTestTypeLister interface.
...
func (s *clusterTestTypeLister) Get(name string) (*examplev1beta1.ClusterTestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1beta1.Resource("clustertesttypes"), name)
	}
