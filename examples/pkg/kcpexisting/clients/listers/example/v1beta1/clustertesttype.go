...
// NewClusterTestTypeLister returns a new listersexamplev1beta1.ClusterTestTypeLister.
// We assume that the indexer:
...
func NewClusterTestTypeLister(indexer cache.Indexer) listersexamplev1beta1.ClusterTestTypeLister {
	return &clusterTestTypeScopedLister{
		listers.New[*examplev1beta1.ClusterTestType](indexer, examplev1beta1.Resource("clustertesttype")),
		indexer,
	}
}
