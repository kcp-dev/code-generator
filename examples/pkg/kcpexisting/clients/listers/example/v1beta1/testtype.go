...
import (
	...
	examplev1beta1listers "acme.corp/pkg/generated/listers/example/v1beta1"
)
...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) examplev1beta1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) examplev1beta1listers.TestTypeLister {
	return &testTypeLister{indexer: s.indexer, clusterName: clusterName}
}

// testTypeLister implements the examplev1beta1listers.TestTypeLister interface.
...
func (s *testTypeLister) List(selector labels.Selector) (ret []*examplev1beta1.TestType, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*examplev1beta1.TestType))
	})
	return ret, err
}

// TestTypes returns an object that can list and get TestTypes in one namespace.
func (s *testTypeLister) TestTypes(namespace string) examplev1beta1listers.TestTypeNamespaceLister {
	return &testTypeNamespaceLister{indexer: s.indexer, clusterName: s.clusterName, namespace: namespace}
}

// testTypeNamespaceLister implements the examplev1beta1listers.TestTypeNamespaceLister interface.
...
func (s *testTypeNamespaceLister) Get(name string) (*examplev1beta1.TestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1beta1.Resource("testtypes"), name)
	}
