...
import (
	...
	examplev2listers "acme.corp/pkg/generated/listers/example/v2"
)
...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) examplev2listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) examplev2listers.TestTypeLister {
	return &testTypeLister{indexer: s.indexer, clusterName: clusterName}
}

// testTypeLister implements the examplev2listers.TestTypeLister interface.
...
func (s *testTypeLister) TestTypes(namespace string) examplev2listers.TestTypeNamespaceLister {
	return &testTypeNamespaceLister{indexer: s.indexer, clusterName: s.clusterName, namespace: namespace}
}

// testTypeNamespaceLister implements the examplev2listers.TestTypeNamespaceLister interface.
...
func (s *testTypeNamespaceLister) Get(name string) (*examplev2.TestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev2.Resource("testtypes"), name)
	}
