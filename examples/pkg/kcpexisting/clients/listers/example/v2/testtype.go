...
type TestTypeClusterLister interface {
	...
	Cluster(cluster logicalcluster.Name) examplev2listers.TestTypeLister
}
...
func (s *testTypeClusterLister) Cluster(cluster logicalcluster.Name) examplev2listers.TestTypeLister {
