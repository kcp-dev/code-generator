...
type TestTypeClusterLister interface {
	...
	Cluster(cluster logicalcluster.Name) examplev1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(cluster logicalcluster.Name) examplev1listers.TestTypeLister {
