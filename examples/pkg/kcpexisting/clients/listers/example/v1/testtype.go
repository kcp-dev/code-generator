...
import (
	...
	examplev1listers "acme.corp/pkg/generated/listers/example/v1"
)
...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) examplev1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) examplev1listers.TestTypeLister {
	return &testTypeLister{indexer: s.indexer, clusterName: clusterName}
}

// testTypeLister implements the examplev1listers.TestTypeLister interface.
...
func (s *testTypeLister) TestTypes(namespace string) examplev1listers.TestTypeNamespaceLister {
	return &testTypeNamespaceLister{indexer: s.indexer, clusterName: s.clusterName, namespace: namespace}
}

// testTypeNamespaceLister implements the examplev1listers.TestTypeNamespaceLister interface.
...
func (s *testTypeNamespaceLister) Get(name string) (*examplev1.TestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1.Resource("testtypes"), name)
	}
