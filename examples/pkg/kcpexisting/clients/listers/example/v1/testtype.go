...
func (l *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) listersexamplev1.TestTypeLister {
	return &testTypeLister{
		kcplisters.New[*examplev1.TestType](l.indexer, clusterName, examplev1.Resource("testtype")),
		l.indexer,
		clusterName,
	}
}
...
// newTestTypeNamespaceLister returns a new listersexamplev1.TestTypeNamespaceLister.
func newTestTypeNamespaceLister(indexer kcplisters.ResourceIndexer[*examplev1.TestType], namespace string) listersexamplev1.TestTypeNamespaceLister {
	return &testTypeNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewTestTypeLister returns a new listersexamplev1.TestTypeLister.
// We assume that the indexer:
...
func NewTestTypeLister(indexer cache.Indexer) listersexamplev1.TestTypeLister {
	return &testTypeScopedLister{
		listers.New[*examplev1.TestType](indexer, examplev1.Resource("testtype")),
		indexer,
	}
}
...
// TestTypes returns an object that can list and get TestTypes in one namespace.
func (l *testTypeScopedLister) TestTypes(namespace string) listersexamplev1.TestTypeNamespaceLister {
