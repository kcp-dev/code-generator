...
type ClusterTestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) examplev1listers.ClusterTestTypeLister
...
func (s *clusterTestTypeClusterLister) Cluster(clusterName logicalcluster.Name) examplev1listers.ClusterTestTypeLister {
	return &clusterTestTypeLister{indexer: s.indexer, clusterName: clusterName}
}

// clusterTestTypeLister implements the examplev1listers.ClusterTestTypeLister interface.
...
func (s *clusterTestTypeLister) Get(name string) (*examplev1.ClusterTestType, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(examplev1.Resource("clustertesttypes"), name)
	}
