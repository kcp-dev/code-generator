...
func (l *clusterTestTypeClusterLister) Cluster(clusterName logicalcluster.Name) listersexistinginterfacesv1.ClusterTestTypeLister {
	return &clusterTestTypeLister{
		kcplisters.New[*existinginterfacesv1.ClusterTestType](l.indexer, clusterName, existinginterfacesv1.Resource("clustertesttype")),
		l.indexer,
		clusterName,
	}
}
...
// NewClusterTestTypeLister returns a new listersexistinginterfacesv1.ClusterTestTypeLister.
// We assume that the indexer:
...
func NewClusterTestTypeLister(indexer cache.Indexer) listersexistinginterfacesv1.ClusterTestTypeLister {
	return &clusterTestTypeScopedLister{
		listers.New[*existinginterfacesv1.ClusterTestType](indexer, existinginterfacesv1.Resource("clustertesttype")),
		indexer,
	}
}
