...
import (
	...
	existinginterfacesv1listers "acme.corp/pkg/generated/listers/existinginterfaces/v1"
)
...
type ClusterTestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) existinginterfacesv1listers.ClusterTestTypeLister
...
func (s *clusterTestTypeClusterLister) Cluster(clusterName logicalcluster.Name) existinginterfacesv1listers.ClusterTestTypeLister {
