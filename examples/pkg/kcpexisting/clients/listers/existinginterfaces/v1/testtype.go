...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) existinginterfacesv1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) existinginterfacesv1listers.TestTypeLister {
