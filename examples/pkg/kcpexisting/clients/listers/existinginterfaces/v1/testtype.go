...
func (l *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) listersexistinginterfacesv1.TestTypeLister {
	return &testTypeLister{
		kcplisters.New[*existinginterfacesv1.TestType](l.indexer, clusterName, existinginterfacesv1.Resource("testtype")),
		l.indexer,
		clusterName,
	}
}
...
// NewTestTypeLister returns a new listersexistinginterfacesv1.TestTypeLister.
// We assume that the indexer:
...
func NewTestTypeLister(indexer cache.Indexer) listersexistinginterfacesv1.TestTypeLister {
	return &testTypeScopedLister{
		listers.New[*existinginterfacesv1.TestType](indexer, existinginterfacesv1.Resource("testtype")),
		indexer,
	}
}
...
// TestTypes returns an object that can list and get TestTypes in one namespace.
func (l *testTypeScopedLister) TestTypes(namespace string) listersexistinginterfacesv1.TestTypeNamespaceLister {
