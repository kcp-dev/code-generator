...
func (l *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) listersexampledashedv1.TestTypeLister {
	return &testTypeLister{
		kcplisters.New[*exampledashedv1.TestType](l.indexer, clusterName, exampledashedv1.Resource("testtype")),
		l.indexer,
		clusterName,
	}
}
...
// newTestTypeNamespaceLister returns a new listersexampledashedv1.TestTypeNamespaceLister.
func newTestTypeNamespaceLister(indexer kcplisters.ResourceIndexer[*exampledashedv1.TestType], namespace string) listersexampledashedv1.TestTypeNamespaceLister {
	return &testTypeNamespaceLister{
		kcplisters.NewNamespaced(indexer, namespace),
	}
}

// NewTestTypeLister returns a new listersexampledashedv1.TestTypeLister.
// We assume that the indexer:
...
func NewTestTypeLister(indexer cache.Indexer) listersexampledashedv1.TestTypeLister {
	return &testTypeScopedLister{
		listers.New[*exampledashedv1.TestType](indexer, exampledashedv1.Resource("testtype")),
		indexer,
	}
}
...
// TestTypes returns an object that can list and get TestTypes in one namespace.
func (l *testTypeScopedLister) TestTypes(namespace string) listersexampledashedv1.TestTypeNamespaceLister {
