...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) secondexamplev1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) secondexamplev1listers.TestTypeLister {
