...
type ClusterTestTypeClusterLister interface {
	...
	Cluster(cluster logicalcluster.Name) example3v1listers.ClusterTestTypeLister
}
...
func (s *clusterTestTypeClusterLister) Cluster(cluster logicalcluster.Name) example3v1listers.ClusterTestTypeLister {
