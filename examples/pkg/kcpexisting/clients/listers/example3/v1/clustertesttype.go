...
func (l *clusterTestTypeClusterLister) Cluster(clusterName logicalcluster.Name) listersexample3v1.ClusterTestTypeLister {
	return &clusterTestTypeLister{
		kcplisters.New[*example3v1.ClusterTestType](l.indexer, clusterName, example3v1.Resource("clustertesttype")),
		l.indexer,
		clusterName,
	}
}
...
// NewClusterTestTypeLister returns a new listersexample3v1.ClusterTestTypeLister.
// We assume that the indexer:
...
func NewClusterTestTypeLister(indexer cache.Indexer) listersexample3v1.ClusterTestTypeLister {
	return &clusterTestTypeScopedLister{
		listers.New[*example3v1.ClusterTestType](indexer, example3v1.Resource("clustertesttype")),
		indexer,
	}
}
