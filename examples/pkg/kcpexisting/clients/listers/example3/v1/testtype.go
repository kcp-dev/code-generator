...
type TestTypeClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) example3v1listers.TestTypeLister
...
func (s *testTypeClusterLister) Cluster(clusterName logicalcluster.Name) example3v1listers.TestTypeLister {
