...
func (c *testTypesClusterClient) Cluster(cluster logicalcluster.Name) kcpexamplev1.TestTypesNamespacer {
...
func (c *testTypesClient) Create(ctx context.Context, testType *examplev1.TestType, opts metav1.CreateOptions) (*examplev1.TestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(testTypesResource, c.Cluster, c.Namespace, testType), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
...
func (c *testTypesClient) Update(ctx context.Context, testType *examplev1.TestType, opts metav1.UpdateOptions) (*examplev1.TestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(testTypesResource, c.Cluster, c.Namespace, testType), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
...
func (c *testTypesClient) UpdateStatus(ctx context.Context, testType *examplev1.TestType, opts metav1.UpdateOptions) (*examplev1.TestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(testTypesResource, c.Cluster, "status", c.Namespace, testType), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
...
func (c *testTypesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(testTypesResource, c.Cluster, c.Namespace, name, opts), &examplev1.TestType{})
	return err
}
...
func (c *testTypesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*examplev1.TestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(testTypesResource, c.Cluster, c.Namespace, name), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
...
func (c *testTypesClient) List(ctx context.Context, opts metav1.ListOptions) (*examplev1.TestTypeList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(testTypesResource, testTypesKind, c.Cluster, c.Namespace, opts), &examplev1.TestTypeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *testTypesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*examplev1.TestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(testTypesResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
...
func (c *testTypesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsexamplev1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (*examplev1.TestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(testTypesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
...
func (c *testTypesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsexamplev1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (*examplev1.TestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(testTypesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &examplev1.TestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.TestType), err
