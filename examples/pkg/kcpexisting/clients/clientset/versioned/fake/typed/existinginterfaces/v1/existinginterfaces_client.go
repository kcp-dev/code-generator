...
func (c *ExistinginterfacesV1ClusterClient) Cluster(cluster logicalcluster.Name) existinginterfacesv1.ExistinginterfacesV1Interface {
	if cluster == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}
	return &ExistinginterfacesV1Client{Fake: c.Fake, Cluster: cluster}
}
