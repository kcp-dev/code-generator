...
type TestTypeClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*somegroup2v1.TestTypeList, error)
...
func (c *testTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*somegroup2v1.TestTypeList, error) {
...
// TestTypesNamespacer can scope to objects within a namespace, returning a somegroup2v1client.TestTypeInterface.
type TestTypesNamespacer interface {
	Namespace(string) somegroup2v1client.TestTypeInterface
}
