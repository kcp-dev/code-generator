...
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) examplev1beta1client.ClusterTestTypeInterface
...
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) examplev1beta1client.ClusterTestTypeInterface {
