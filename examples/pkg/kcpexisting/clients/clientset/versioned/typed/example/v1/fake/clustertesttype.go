...
func (c *clusterTestTypesClusterClient) Cluster(clusterPath logicalcluster.Path) examplev1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClient) Create(ctx context.Context, clusterTestType *examplev1.ClusterTestType, opts metav1.CreateOptions) (*examplev1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(clusterTestTypesResource, c.ClusterPath, clusterTestType), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterTestTypesClient) Update(ctx context.Context, clusterTestType *examplev1.ClusterTestType, opts metav1.UpdateOptions) (*examplev1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(clusterTestTypesResource, c.ClusterPath, clusterTestType), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
...
func (c *clusterTestTypesClient) UpdateStatus(ctx context.Context, clusterTestType *examplev1.ClusterTestType, opts metav1.UpdateOptions) (*examplev1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(clusterTestTypesResource, c.ClusterPath, "status", clusterTestType), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
...
func (c *clusterTestTypesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(clusterTestTypesResource, c.ClusterPath, name, opts), &examplev1.ClusterTestType{})
	return err
}
...
func (c *clusterTestTypesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*examplev1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(clusterTestTypesResource, c.ClusterPath, name), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
...
func (c *clusterTestTypesClient) List(ctx context.Context, opts metav1.ListOptions) (*examplev1.ClusterTestTypeList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(clusterTestTypesResource, clusterTestTypesKind, c.ClusterPath, opts), &examplev1.ClusterTestTypeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterTestTypesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*examplev1.ClusterTestType, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, name, pt, data, subresources...), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
...
func (c *clusterTestTypesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsexamplev1.ClusterTestTypeApplyConfiguration, opts metav1.ApplyOptions) (*examplev1.ClusterTestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, *name, types.ApplyPatchType, data), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
...
func (c *clusterTestTypesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsexamplev1.ClusterTestTypeApplyConfiguration, opts metav1.ApplyOptions) (*examplev1.ClusterTestType, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterTestTypesResource, c.ClusterPath, *name, types.ApplyPatchType, data, "status"), &examplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*examplev1.ClusterTestType), err
