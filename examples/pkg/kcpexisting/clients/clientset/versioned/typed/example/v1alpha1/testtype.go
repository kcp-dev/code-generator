...
func (c *testTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*examplev1alpha1.TestTypeList, error) {
...
// TestTypesNamespacer can scope to objects within a namespace, returning a examplev1alpha1client.TestTypeInterface.
type TestTypesNamespacer interface {
	Namespace(string) examplev1alpha1client.TestTypeInterface
}
