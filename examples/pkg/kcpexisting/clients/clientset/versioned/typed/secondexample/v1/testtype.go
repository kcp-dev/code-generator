...
// TestTypesNamespacer can scope to objects within a namespace, returning a secondexamplev1client.TestTypeInterface.
type TestTypesNamespacer interface {
	Namespace(string) secondexamplev1client.TestTypeInterface
}
