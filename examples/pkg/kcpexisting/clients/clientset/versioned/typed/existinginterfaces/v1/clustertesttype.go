...
type ClusterTestTypeClusterInterface interface {
	Cluster(logicalcluster.Path) existinginterfacesv1client.ClusterTestTypeInterface
...
type clusterTestTypesClusterInterface struct {
	clientCache kcpclient.Cache[*existinginterfacesv1client.ExistinginterfacesV1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) existinginterfacesv1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*existinginterfacesv1.ClusterTestTypeList, error) {
