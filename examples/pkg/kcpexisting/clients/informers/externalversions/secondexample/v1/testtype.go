...
func (f *testTypeClusterInformer) Lister() listerssecondexamplev1.TestTypeClusterLister {
	return listerssecondexamplev1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) secondexamplev1.TestTypeInformer {
...
func (f *testTypeInformer) Lister() generatedlisterssecondexamplev1.TestTypeLister {
	return f.lister
}
