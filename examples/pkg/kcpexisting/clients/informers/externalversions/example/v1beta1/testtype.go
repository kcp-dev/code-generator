...
func (f *testTypeClusterInformer) Lister() listersexamplev1beta1.TestTypeClusterLister {
	return listersexamplev1beta1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) examplev1beta1.TestTypeInformer {
...
func (f *testTypeInformer) Lister() generatedlistersexamplev1beta1.TestTypeLister {
	return f.lister
}
