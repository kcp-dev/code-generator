...
type ClusterTestTypeClusterInformer interface {
	...
	ClusterWithContext(context.Context, logicalcluster.Name) upstreamexamplev1beta1informers.ClusterTestTypeInformer
...
func (f *clusterTestTypeClusterInformer) ClusterWithContext(ctx context.Context, clusterName logicalcluster.Name) upstreamexamplev1beta1informers.ClusterTestTypeInformer {
	return &clusterTestTypeInformer{
