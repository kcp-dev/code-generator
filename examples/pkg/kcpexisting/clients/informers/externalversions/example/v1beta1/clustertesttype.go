...
func (f *clusterTestTypeClusterInformer) Lister() listersexamplev1beta1.ClusterTestTypeClusterLister {
	return listersexamplev1beta1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *clusterTestTypeClusterInformer) Cluster(clusterName logicalcluster.Name) examplev1beta1.ClusterTestTypeInformer {
...
func (f *clusterTestTypeInformer) Lister() generatedlistersexamplev1beta1.ClusterTestTypeLister {
	return f.lister
}
