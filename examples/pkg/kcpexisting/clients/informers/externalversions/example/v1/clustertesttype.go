...
func (f *clusterTestTypeClusterInformer) Lister() listersexamplev1.ClusterTestTypeClusterLister {
	return listersexamplev1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *clusterTestTypeClusterInformer) Cluster(clusterName logicalcluster.Name) examplev1.ClusterTestTypeInformer {
...
func (f *clusterTestTypeInformer) Lister() generatedlistersexamplev1.ClusterTestTypeLister {
	return f.lister
}
