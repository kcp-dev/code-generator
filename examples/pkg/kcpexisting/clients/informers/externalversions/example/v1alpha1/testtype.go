...
func (f *testTypeClusterInformer) Lister() listersexamplev1alpha1.TestTypeClusterLister {
	return listersexamplev1alpha1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) examplev1alpha1.TestTypeInformer {
...
func (f *testTypeInformer) Lister() generatedlistersexamplev1alpha1.TestTypeLister {
	return f.lister
}
