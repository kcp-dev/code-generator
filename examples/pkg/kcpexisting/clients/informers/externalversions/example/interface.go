...
import (
	"acme.corp/pkg/kcpexisting/clients/informers/externalversions/example/v1"
	"acme.corp/pkg/kcpexisting/clients/informers/externalversions/example/v1alpha1"
	"acme.corp/pkg/kcpexisting/clients/informers/externalversions/example/v1beta1"
	"acme.corp/pkg/kcpexisting/clients/informers/externalversions/example/v2"
