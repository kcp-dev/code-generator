...
func (f *testTypeClusterInformer) Lister() listersexamplev2.TestTypeClusterLister {
	return listersexamplev2.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) examplev2.TestTypeInformer {
...
func (f *testTypeInformer) Lister() generatedlistersexamplev2.TestTypeLister {
	return f.lister
}
