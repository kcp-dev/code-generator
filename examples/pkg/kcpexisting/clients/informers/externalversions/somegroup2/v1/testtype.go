...
import (
	...
	upstreamsomegroup2v1informers "acme.corp/pkg/generated/informers/externalversions/somegroup2/v1"
	upstreamsomegroup2v1listers "acme.corp/pkg/generated/listers/somegroup2/v1"
	...
	somegroup2v1listers "acme.corp/pkg/kcpexisting/clients/listers/somegroup2/v1"
)

// TestTypeClusterInformer provides access to a shared informer and lister for
// TestTypes.
type TestTypeClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamsomegroup2v1informers.TestTypeInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() somegroup2v1listers.TestTypeClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.Somegroup2V1().TestTypes().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Somegroup2V1().TestTypes().Watch(context.TODO(), options)
			},
		},
		&somegroup2v1.TestType{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *testTypeClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&somegroup2v1.TestType{}, f.defaultInformer)
}

func (f *testTypeClusterInformer) Lister() somegroup2v1listers.TestTypeClusterLister {
	return somegroup2v1listers.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamsomegroup2v1informers.TestTypeInformer {
...
type testTypeInformer struct {
	...
	lister   upstreamsomegroup2v1listers.TestTypeLister
}
...
func (f *testTypeInformer) Lister() upstreamsomegroup2v1listers.TestTypeLister {
	return f.lister
}
