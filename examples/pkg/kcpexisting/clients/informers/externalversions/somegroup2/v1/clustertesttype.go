...
type ClusterTestTypeClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamsomegroup2v1informers.ClusterTestTypeInformer
...
func (f *clusterTestTypeClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamsomegroup2v1informers.ClusterTestTypeInformer {
...
type clusterTestTypeInformer struct {
	...
	lister   upstreamsomegroup2v1listers.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() upstreamsomegroup2v1listers.ClusterTestTypeLister {
	return f.lister
}
