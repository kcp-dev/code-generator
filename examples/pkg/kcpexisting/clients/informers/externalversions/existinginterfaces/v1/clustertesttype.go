...
func (f *clusterTestTypeClusterInformer) Lister() listersexistinginterfacesv1.ClusterTestTypeClusterLister {
	return listersexistinginterfacesv1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *clusterTestTypeClusterInformer) Cluster(clusterName logicalcluster.Name) existinginterfacesv1.ClusterTestTypeInformer {
...
func (f *clusterTestTypeInformer) Lister() generatedlistersexistinginterfacesv1.ClusterTestTypeLister {
	return f.lister
}
