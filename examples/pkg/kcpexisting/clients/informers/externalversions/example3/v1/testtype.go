...
func (f *testTypeClusterInformer) Lister() listersexample3v1.TestTypeClusterLister {
	return listersexample3v1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}

func (f *testTypeClusterInformer) Cluster(clusterName logicalcluster.Name) example3v1.TestTypeInformer {
...
func (f *testTypeInformer) Lister() generatedlistersexample3v1.TestTypeLister {
	return f.lister
}
