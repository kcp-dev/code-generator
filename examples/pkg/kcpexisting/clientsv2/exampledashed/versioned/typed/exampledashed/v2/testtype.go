...
type TestTypeClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv2.TestTypeList, error)
...
func (c *testTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*exampledashedv2.TestTypeList, error) {
...
// TestTypesNamespacer can scope to objects within a namespace, returning a exampledashedv2client.TestTypeInterface.
type TestTypesNamespacer interface {
	Namespace(string) exampledashedv2client.TestTypeInterface
}
