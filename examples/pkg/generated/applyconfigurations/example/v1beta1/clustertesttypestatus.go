...
// ClusterTestTypeStatusApplyConfiguration represents an declarative configuration of the ClusterTestTypeStatus type for use
// with apply.
type ClusterTestTypeStatusApplyConfiguration struct {
	Blah *string `json:"blah,omitempty"`
}

// ClusterTestTypeStatusApplyConfiguration constructs an declarative configuration of the ClusterTestTypeStatus type for use with
// apply.
