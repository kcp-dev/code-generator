...
type clusterTestTypes struct {
	*gentype.ClientWithList[*examplev1.ClusterTestType, *examplev1.ClusterTestTypeList]
}
...
func newClusterTestTypes(c *ExampleV1Client) *clusterTestTypes {
	return &clusterTestTypes{
		gentype.NewClientWithList[*examplev1.ClusterTestType, *examplev1.ClusterTestTypeList](
			"clustertesttypes",
			c.RESTClient(),
