...
func (c *FakeTestTypes) CreateField(ctx context.Context, testTypeName string, field *v1.Field, opts metav1.CreateOptions) (result *v1.Field, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateSubresourceAction(testtypesResource, testTypeName, "field", c.ns, field), &v1.Field{})
...
func (c *FakeTestTypes) UpdateField(ctx context.Context, testTypeName string, field *v1.Field, opts metav1.UpdateOptions) (result *v1.Field, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(testtypesResource, "field", c.ns, field), &v1.Field{})
...
func (c *FakeTestTypes) GetField(ctx context.Context, testTypeName string, options metav1.GetOptions) (result *v1.Field, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetSubresourceAction(testtypesResource, c.ns, "field", testTypeName), &v1.Field{})
