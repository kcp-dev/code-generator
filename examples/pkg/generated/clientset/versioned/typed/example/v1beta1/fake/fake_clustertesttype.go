...
var clustertesttypesResource = v1beta1.SchemeGroupVersion.WithResource("clustertesttypes")

var clustertesttypesKind = v1beta1.SchemeGroupVersion.WithKind("ClusterTestType")
...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterTestType, err error) {
	emptyResult := &v1beta1.ClusterTestType{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ClusterTestTypeList, err error) {
	emptyResult := &v1beta1.ClusterTestTypeList{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.UpdateOptions) (result *v1beta1.ClusterTestType, err error) {
	emptyResult := &v1beta1.ClusterTestType{}
	obj, err := c.Fake.
