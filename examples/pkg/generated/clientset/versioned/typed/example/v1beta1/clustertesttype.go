...
type ClusterTestTypeInterface interface {
	Create(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.CreateOptions) (*v1beta1.ClusterTestType, error)
	Update(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.UpdateOptions) (*v1beta1.ClusterTestType, error)
	UpdateStatus(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.UpdateOptions) (*v1beta1.ClusterTestType, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ClusterTestType, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ClusterTestTypeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterTestType, err error)
...
func (c *clusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterTestType, err error) {
	result = &v1beta1.ClusterTestType{}
	err = c.client.Get().
...
func (c *clusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ClusterTestTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ClusterTestTypeList{}
	err = c.client.Get().
		Resource("clustertesttypes").
...
func (c *clusterTestTypes) Create(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.CreateOptions) (result *v1beta1.ClusterTestType, err error) {
	result = &v1beta1.ClusterTestType{}
	err = c.client.Post().
		Resource("clustertesttypes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterTestTypes) Update(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.UpdateOptions) (result *v1beta1.ClusterTestType, err error) {
	result = &v1beta1.ClusterTestType{}
	err = c.client.Put().
		Resource("clustertesttypes").
...
func (c *clusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *v1beta1.ClusterTestType, opts v1.UpdateOptions) (result *v1beta1.ClusterTestType, err error) {
	result = &v1beta1.ClusterTestType{}
	err = c.client.Put().
		Resource("clustertesttypes").
		Name(clusterTestType.Name).
...
func (c *clusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterTestType, err error) {
	result = &v1beta1.ClusterTestType{}
