...
type testTypes struct {
	*gentype.ClientWithList[*examplev1alpha1.TestType, *examplev1alpha1.TestTypeList]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *ExampleV1alpha1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithList[*examplev1alpha1.TestType, *examplev1alpha1.TestTypeList](
			"testtypes",
			c.RESTClient(),
