...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterTestType, err error) {
	emptyResult := &v1alpha1.ClusterTestType{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterTestTypeList, err error) {
	emptyResult := &v1alpha1.ClusterTestTypeList{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *v1alpha1.ClusterTestType, opts v1.UpdateOptions) (result *v1alpha1.ClusterTestType, err error) {
	emptyResult := &v1alpha1.ClusterTestType{}
	obj, err := c.Fake.
