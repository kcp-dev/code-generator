...
type clusterTestTypes struct {
	*gentype.ClientWithList[*v1alpha1.ClusterTestType, *v1alpha1.ClusterTestTypeList]
}
...
func newClusterTestTypes(c *ExampleV1alpha1Client) *clusterTestTypes {
	return &clusterTestTypes{
		gentype.NewClientWithList[*v1alpha1.ClusterTestType, *v1alpha1.ClusterTestTypeList](
			"clustertesttypes",
			c.RESTClient(),
