...
func (c *clusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.ClusterTestType, err error) {
	result = &v2.ClusterTestType{}
	err = c.client.Get().
...
func (c *clusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *v2.ClusterTestTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2.ClusterTestTypeList{}
	err = c.client.Get().
		Resource("clustertesttypes").
...
func (c *clusterTestTypes) Create(ctx context.Context, clusterTestType *v2.ClusterTestType, opts v1.CreateOptions) (result *v2.ClusterTestType, err error) {
	result = &v2.ClusterTestType{}
	err = c.client.Post().
		Resource("clustertesttypes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *clusterTestTypes) Update(ctx context.Context, clusterTestType *v2.ClusterTestType, opts v1.UpdateOptions) (result *v2.ClusterTestType, err error) {
	result = &v2.ClusterTestType{}
	err = c.client.Put().
		Resource("clustertesttypes").
...
func (c *clusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *v2.ClusterTestType, opts v1.UpdateOptions) (result *v2.ClusterTestType, err error) {
	result = &v2.ClusterTestType{}
	err = c.client.Put().
		Resource("clustertesttypes").
		Name(clusterTestType.Name).
...
func (c *clusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.ClusterTestType, err error) {
	result = &v2.ClusterTestType{}
