...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.ClusterTestType, err error) {
	emptyResult := &v2.ClusterTestType{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *v2.ClusterTestTypeList, err error) {
	emptyResult := &v2.ClusterTestTypeList{}
	obj, err := c.Fake.
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *v2.ClusterTestType, opts v1.UpdateOptions) (result *v2.ClusterTestType, err error) {
	emptyResult := &v2.ClusterTestType{}
	obj, err := c.Fake.
