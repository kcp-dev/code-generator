...
type fakeClusterTestTypes struct {
	*gentype.FakeClientWithList[*v1.ClusterTestType, *v1.ClusterTestTypeList]
	Fake *FakeExistinginterfacesV1
}

func newFakeClusterTestTypes(fake *FakeExistinginterfacesV1) existinginterfacesv1.ClusterTestTypeInterface {
	return &fakeClusterTestTypes{
		gentype.NewFakeClientWithList[*v1.ClusterTestType, *v1.ClusterTestTypeList](
			fake.Fake,
			"",
