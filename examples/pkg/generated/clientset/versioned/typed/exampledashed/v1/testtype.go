...
type testTypes struct {
	*gentype.ClientWithList[*exampledashedv1.TestType, *exampledashedv1.TestTypeList]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *ExampleDashedV1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithList[*exampledashedv1.TestType, *exampledashedv1.TestTypeList](
			"testtypes",
			c.RESTClient(),
