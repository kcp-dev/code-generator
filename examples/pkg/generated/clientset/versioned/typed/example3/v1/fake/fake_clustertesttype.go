...
var clustertesttypesResource = schema.GroupVersionResource{Group: "example3", Version: "v1", Resource: "clustertesttypes"}

var clustertesttypesKind = schema.GroupVersionKind{Group: "example3", Version: "v1", Kind: "ClusterTestType"}
...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *example3v1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustertesttypesResource, name), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *example3v1.ClusterTestTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustertesttypesResource, clustertesttypesKind, opts), &example3v1.ClusterTestTypeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterTestTypes) Create(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts v1.CreateOptions) (result *example3v1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustertesttypesResource, clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Update(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts v1.UpdateOptions) (result *example3v1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustertesttypesResource, clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *example3v1.ClusterTestType, opts v1.UpdateOptions) (*example3v1.ClusterTestType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustertesttypesResource, "status", clusterTestType), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clustertesttypesResource, name, opts), &example3v1.ClusterTestType{})
	return err
}
...
func (c *FakeClusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *example3v1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustertesttypesResource, name, pt, data, subresources...), &example3v1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*example3v1.ClusterTestType), err
