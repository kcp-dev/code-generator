...
type clusterTestTypes struct {
	*gentype.ClientWithList[*example3v1.ClusterTestType, *example3v1.ClusterTestTypeList]
}
...
func newClusterTestTypes(c *Example3V1Client) *clusterTestTypes {
	return &clusterTestTypes{
		gentype.NewClientWithList[*example3v1.ClusterTestType, *example3v1.ClusterTestTypeList](
			"clustertesttypes",
			c.RESTClient(),
