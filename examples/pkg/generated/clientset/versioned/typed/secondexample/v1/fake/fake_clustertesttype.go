...
func (c *FakeClusterTestTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *secondexamplev1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustertesttypesResource, name), &secondexamplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterTestTypes) List(ctx context.Context, opts v1.ListOptions) (result *secondexamplev1.ClusterTestTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustertesttypesResource, clustertesttypesKind, opts), &secondexamplev1.ClusterTestTypeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterTestTypes) Create(ctx context.Context, clusterTestType *secondexamplev1.ClusterTestType, opts v1.CreateOptions) (result *secondexamplev1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustertesttypesResource, clusterTestType), &secondexamplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*secondexamplev1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Update(ctx context.Context, clusterTestType *secondexamplev1.ClusterTestType, opts v1.UpdateOptions) (result *secondexamplev1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustertesttypesResource, clusterTestType), &secondexamplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*secondexamplev1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) UpdateStatus(ctx context.Context, clusterTestType *secondexamplev1.ClusterTestType, opts v1.UpdateOptions) (*secondexamplev1.ClusterTestType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustertesttypesResource, "status", clusterTestType), &secondexamplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*secondexamplev1.ClusterTestType), err
...
func (c *FakeClusterTestTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clustertesttypesResource, name, opts), &secondexamplev1.ClusterTestType{})
	return err
}
...
func (c *FakeClusterTestTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *secondexamplev1.ClusterTestType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustertesttypesResource, name, pt, data, subresources...), &secondexamplev1.ClusterTestType{})
	if obj == nil {
		return nil, err
	}
	return obj.(*secondexamplev1.ClusterTestType), err
