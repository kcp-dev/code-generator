...
type testTypes struct {
	*gentype.ClientWithList[*secondexamplev1.TestType, *secondexamplev1.TestTypeList]
}

// newTestTypes returns a TestTypes
func newTestTypes(c *SecondexampleV1Client, namespace string) *testTypes {
	return &testTypes{
		gentype.NewClientWithList[*secondexamplev1.TestType, *secondexamplev1.TestTypeList](
			"testtypes",
			c.RESTClient(),
