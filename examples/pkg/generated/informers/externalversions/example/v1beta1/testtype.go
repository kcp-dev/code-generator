...
import (
	...
	v1beta1 "acme.corp/pkg/generated/listers/example/v1beta1"
)
...
func (f *testTypeInformer) Lister() v1beta1.TestTypeLister {
	return v1beta1.NewTestTypeLister(f.Informer().GetIndexer())
}
