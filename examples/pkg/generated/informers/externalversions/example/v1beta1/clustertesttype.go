...
type ClusterTestTypeInformer interface {
	...
	Lister() v1beta1.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() v1beta1.ClusterTestTypeLister {
	return v1beta1.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
