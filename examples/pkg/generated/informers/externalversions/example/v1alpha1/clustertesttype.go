...
// Code generated by informer-gen-v0.28.1. DO NOT EDIT.
...
import (
	...
	v1alpha1 "acme.corp/pkg/generated/listers/example/v1alpha1"
)
...
type ClusterTestTypeInformer interface {
	...
	Lister() v1alpha1.ClusterTestTypeLister
}
...
func (f *clusterTestTypeInformer) Lister() v1alpha1.ClusterTestTypeLister {
	return v1alpha1.NewClusterTestTypeLister(f.Informer().GetIndexer())
}
