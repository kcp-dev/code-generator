...
// Code generated by lister-gen-v0.24.0. DO NOT EDIT.
...
type WithoutVerbTypeLister interface {
	...
	List(selector labels.Selector) (ret []*v1.WithoutVerbType, err error)
...
func NewWithoutVerbTypeLister(indexer cache.Indexer) WithoutVerbTypeLister {
	return &withoutVerbTypeLister{indexer: indexer}
}

// List lists all WithoutVerbTypes in the indexer.
func (s *withoutVerbTypeLister) List(selector labels.Selector) (ret []*v1.WithoutVerbType, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.WithoutVerbType))
	})
	return ret, err
}
...
func (s *withoutVerbTypeLister) WithoutVerbTypes(namespace string) WithoutVerbTypeNamespaceLister {
	return withoutVerbTypeNamespaceLister{indexer: s.indexer, namespace: namespace}
}
...
type WithoutVerbTypeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1.WithoutVerbType, error)
...
// List lists all WithoutVerbTypes in the indexer for a given namespace.
func (s withoutVerbTypeNamespaceLister) List(selector labels.Selector) (ret []*v1.WithoutVerbType, err error) {
...
// Get retrieves the WithoutVerbType from the indexer for a given namespace and name.
func (s withoutVerbTypeNamespaceLister) Get(name string) (*v1.WithoutVerbType, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("withoutverbtype"), name)
	}
	return obj.(*v1.WithoutVerbType), nil
}
