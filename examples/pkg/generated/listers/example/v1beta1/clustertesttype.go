...
type clusterTestTypeLister struct {
	listers.ResourceIndexer[*v1beta1.ClusterTestType]
}
...
func NewClusterTestTypeLister(indexer cache.Indexer) ClusterTestTypeLister {
	return &clusterTestTypeLister{listers.New[*v1beta1.ClusterTestType](indexer, v1beta1.Resource("clustertesttype"))}
}
