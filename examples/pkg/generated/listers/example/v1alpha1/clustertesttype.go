...
type clusterTestTypeLister struct {
	listers.ResourceIndexer[*v1alpha1.ClusterTestType]
}
...
func NewClusterTestTypeLister(indexer cache.Indexer) ClusterTestTypeLister {
	return &clusterTestTypeLister{listers.New[*v1alpha1.ClusterTestType](indexer, v1alpha1.Resource("clustertesttype"))}
}
