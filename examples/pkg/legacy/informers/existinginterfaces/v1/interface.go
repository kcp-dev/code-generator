...
import (
	upstreaminformers "github.com/kcp-dev/code-generator/examples/pkg/generated/informers/externalversions/existinginterfaces/v1"
...
func (v Interface) ClusterTestTypes() upstreaminformers.ClusterTestTypeInformer {
	return &ClusterTestTypeInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// TestTypes returns a TestTypeInformer.
func (v Interface) TestTypes() upstreaminformers.TestTypeInformer {
