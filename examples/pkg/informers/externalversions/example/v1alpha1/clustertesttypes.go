...
type ClusterTestTypeInformer interface {
	...
	Lister() v1alpha1.ClusterTestTypeClusterLister
}
...
func (f *clusterTestTypeInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredClusterTestTypeInformer(
		client,
		resyncPeriod,
		cache.Indexers{
...
func (f *clusterTestTypeInformer) Lister() v1alpha1.ClusterTestTypeClusterLister {
	return v1alpha1.NewClusterTestTypeClusterLister(f.Informer().GetIndexer())
}
