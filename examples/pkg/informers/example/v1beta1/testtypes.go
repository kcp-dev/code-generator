...
import (
	...
	v1beta1 "github.com/kcp-dev/code-generator/examples/pkg/listers/example/v1beta1"
)
...
type TestTypeInformer interface {
	...
	Lister() v1beta1.TestTypeClusterLister
}
...
func (f *testTypeInformer) Lister() v1beta1.TestTypeClusterLister {
	return v1beta1.NewTestTypeClusterLister(f.Informer().GetIndexer())
}
