...
type IngressInformer interface {
	...
	Lister() networkingv1beta1listers.IngressLister
}
...
func (f *ingressScopedInformer) Lister() networkingv1beta1listers.IngressLister {
	return networkingv1beta1listers.NewIngressLister(f.Informer().GetIndexer())
}
