...
// IPAddresses returns a IPAddressInformer
func (v *scopedVersion) IPAddresses() IPAddressInformer {
	return &iPAddressScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// ServiceCIDRs returns a ServiceCIDRInformer
func (v *scopedVersion) ServiceCIDRs() ServiceCIDRInformer {
	return &serviceCIDRScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
