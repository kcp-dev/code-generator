...
type IPAddressInformer interface {
	...
	Lister() networkingv1beta1listers.IPAddressLister
}
...
func (f *iPAddressInformer) Lister() networkingv1beta1listers.IPAddressLister {
	return f.lister
}
...
func (f *iPAddressScopedInformer) Lister() networkingv1beta1listers.IPAddressLister {
	return networkingv1beta1listers.NewIPAddressLister(f.Informer().GetIndexer())
}
