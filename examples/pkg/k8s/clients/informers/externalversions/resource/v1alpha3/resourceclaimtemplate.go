...
type ResourceClaimTemplateInformer interface {
	...
	Lister() resourcev1alpha3listers.ResourceClaimTemplateLister
}
...
func (f *resourceClaimTemplateInformer) Lister() resourcev1alpha3listers.ResourceClaimTemplateLister {
	return f.lister
}
...
func (f *resourceClaimTemplateScopedInformer) Lister() resourcev1alpha3listers.ResourceClaimTemplateLister {
	return resourcev1alpha3listers.NewResourceClaimTemplateLister(f.Informer().GetIndexer())
}
