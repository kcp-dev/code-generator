...
type ResourceSliceInformer interface {
	...
	Lister() resourcev1alpha2listers.ResourceSliceLister
}
...
func (f *resourceSliceInformer) Lister() resourcev1alpha2listers.ResourceSliceLister {
	return f.lister
}
...
func (f *resourceSliceScopedInformer) Lister() resourcev1alpha2listers.ResourceSliceLister {
	return resourcev1alpha2listers.NewResourceSliceLister(f.Informer().GetIndexer())
}
