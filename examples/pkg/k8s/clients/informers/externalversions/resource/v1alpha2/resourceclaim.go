...
type ResourceClaimInformer interface {
	...
	Lister() resourcev1alpha2listers.ResourceClaimLister
}
...
func (f *resourceClaimInformer) Lister() resourcev1alpha2listers.ResourceClaimLister {
	return f.lister
}
...
func (f *resourceClaimScopedInformer) Lister() resourcev1alpha2listers.ResourceClaimLister {
	return resourcev1alpha2listers.NewResourceClaimLister(f.Informer().GetIndexer())
}
