...
import (
	...
	schedulingv1beta1listers "acme.corp/pkg/kcp/clients/listers/scheduling/v1beta1"
)
...
func (f *priorityClassScopedInformer) Lister() schedulingv1beta1listers.PriorityClassLister {
	return schedulingv1beta1listers.NewPriorityClassLister(f.Informer().GetIndexer())
}
