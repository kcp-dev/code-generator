...
import (
	...
	schedulingv1listers "acme.corp/pkg/kcp/clients/listers/scheduling/v1"
)
...
func (f *priorityClassScopedInformer) Lister() schedulingv1listers.PriorityClassLister {
	return schedulingv1listers.NewPriorityClassLister(f.Informer().GetIndexer())
}
