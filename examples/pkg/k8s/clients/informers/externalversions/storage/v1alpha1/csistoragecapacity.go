...
type CSIStorageCapacityInformer interface {
	...
	Lister() storagev1alpha1listers.CSIStorageCapacityLister
}
...
func (f *cSIStorageCapacityScopedInformer) Lister() storagev1alpha1listers.CSIStorageCapacityLister {
	return storagev1alpha1listers.NewCSIStorageCapacityLister(f.Informer().GetIndexer())
}
