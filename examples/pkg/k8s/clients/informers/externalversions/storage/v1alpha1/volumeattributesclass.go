...
func (f *volumeAttributesClassInformer) Lister() storagev1alpha1listers.VolumeAttributesClassLister {
	return f.lister
}
...
func (f *volumeAttributesClassScopedInformer) Lister() storagev1alpha1listers.VolumeAttributesClassLister {
	return storagev1alpha1listers.NewVolumeAttributesClassLister(f.Informer().GetIndexer())
}
