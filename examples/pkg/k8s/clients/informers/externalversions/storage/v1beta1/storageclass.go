...
type StorageClassInformer interface {
	...
	Lister() storagev1beta1listers.StorageClassLister
}
...
func (f *storageClassScopedInformer) Lister() storagev1beta1listers.StorageClassLister {
	return storagev1beta1listers.NewStorageClassLister(f.Informer().GetIndexer())
}
