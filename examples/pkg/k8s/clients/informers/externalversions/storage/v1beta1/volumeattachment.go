...
type VolumeAttachmentInformer interface {
	...
	Lister() storagev1beta1listers.VolumeAttachmentLister
}
...
func (f *volumeAttachmentScopedInformer) Lister() storagev1beta1listers.VolumeAttachmentLister {
	return storagev1beta1listers.NewVolumeAttachmentLister(f.Informer().GetIndexer())
}
