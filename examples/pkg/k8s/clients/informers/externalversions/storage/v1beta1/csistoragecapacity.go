...
type CSIStorageCapacityInformer interface {
	...
	Lister() storagev1beta1listers.CSIStorageCapacityLister
}
...
func (f *cSIStorageCapacityScopedInformer) Lister() storagev1beta1listers.CSIStorageCapacityLister {
	return storagev1beta1listers.NewCSIStorageCapacityLister(f.Informer().GetIndexer())
}
