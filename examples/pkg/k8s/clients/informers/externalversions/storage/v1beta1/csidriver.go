...
type CSIDriverInformer interface {
	...
	Lister() storagev1beta1listers.CSIDriverLister
}
...
func (f *cSIDriverScopedInformer) Lister() storagev1beta1listers.CSIDriverLister {
	return storagev1beta1listers.NewCSIDriverLister(f.Informer().GetIndexer())
}
