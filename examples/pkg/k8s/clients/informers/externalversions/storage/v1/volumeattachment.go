...
func (f *volumeAttachmentScopedInformer) Lister() storagev1listers.VolumeAttachmentLister {
	return storagev1listers.NewVolumeAttachmentLister(f.Informer().GetIndexer())
}
