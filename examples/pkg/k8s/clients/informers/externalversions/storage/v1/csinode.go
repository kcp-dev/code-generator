...
type CSINodeInformer interface {
	...
	Lister() storagev1listers.CSINodeLister
}
...
func (f *cSINodeScopedInformer) Lister() storagev1listers.CSINodeLister {
	return storagev1listers.NewCSINodeLister(f.Informer().GetIndexer())
}
