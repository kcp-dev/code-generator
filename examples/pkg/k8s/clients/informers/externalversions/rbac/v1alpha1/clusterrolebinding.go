...
func (f *clusterRoleBindingScopedInformer) Lister() rbacv1alpha1listers.ClusterRoleBindingLister {
	return rbacv1alpha1listers.NewClusterRoleBindingLister(f.Informer().GetIndexer())
}
