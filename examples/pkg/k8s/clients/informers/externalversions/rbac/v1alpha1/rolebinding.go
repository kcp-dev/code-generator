...
type RoleBindingInformer interface {
	...
	Lister() rbacv1alpha1listers.RoleBindingLister
}
...
func (f *roleBindingScopedInformer) Lister() rbacv1alpha1listers.RoleBindingLister {
	return rbacv1alpha1listers.NewRoleBindingLister(f.Informer().GetIndexer())
}
