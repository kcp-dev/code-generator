...
import (
	...
	rbacv1listers "acme.corp/pkg/kcp/clients/listers/rbac/v1"
)
...
func (f *roleBindingScopedInformer) Lister() rbacv1listers.RoleBindingLister {
	return rbacv1listers.NewRoleBindingLister(f.Informer().GetIndexer())
}
