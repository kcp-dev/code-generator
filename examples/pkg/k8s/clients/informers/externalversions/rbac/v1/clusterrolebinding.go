...
func (f *clusterRoleBindingScopedInformer) Lister() rbacv1listers.ClusterRoleBindingLister {
	return rbacv1listers.NewClusterRoleBindingLister(f.Informer().GetIndexer())
}
