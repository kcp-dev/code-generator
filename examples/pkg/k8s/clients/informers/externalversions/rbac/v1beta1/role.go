...
type RoleInformer interface {
	...
	Lister() rbacv1beta1listers.RoleLister
}
...
func (f *roleScopedInformer) Lister() rbacv1beta1listers.RoleLister {
	return rbacv1beta1listers.NewRoleLister(f.Informer().GetIndexer())
}
