...
type ClusterRoleInformer interface {
	...
	Lister() rbacv1beta1listers.ClusterRoleLister
}
...
func (f *clusterRoleScopedInformer) Lister() rbacv1beta1listers.ClusterRoleLister {
	return rbacv1beta1listers.NewClusterRoleLister(f.Informer().GetIndexer())
}
