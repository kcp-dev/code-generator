...
import (
	...
	flowcontrolv1beta1listers "acme.corp/pkg/kcp/clients/listers/flowcontrol/v1beta1"
)
...
type PriorityLevelConfigurationInformer interface {
	...
	Lister() flowcontrolv1beta1listers.PriorityLevelConfigurationLister
}
...
func (f *priorityLevelConfigurationScopedInformer) Lister() flowcontrolv1beta1listers.PriorityLevelConfigurationLister {
	return flowcontrolv1beta1listers.NewPriorityLevelConfigurationLister(f.Informer().GetIndexer())
}
