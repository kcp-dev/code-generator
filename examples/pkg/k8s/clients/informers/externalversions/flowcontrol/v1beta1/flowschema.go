...
type FlowSchemaInformer interface {
	...
	Lister() flowcontrolv1beta1listers.FlowSchemaLister
}
...
func (f *flowSchemaScopedInformer) Lister() flowcontrolv1beta1listers.FlowSchemaLister {
	return flowcontrolv1beta1listers.NewFlowSchemaLister(f.Informer().GetIndexer())
}
