...
type FlowSchemaInformer interface {
	...
	Lister() flowcontrolv1beta2listers.FlowSchemaLister
}
...
func (f *flowSchemaScopedInformer) Lister() flowcontrolv1beta2listers.FlowSchemaLister {
	return flowcontrolv1beta2listers.NewFlowSchemaLister(f.Informer().GetIndexer())
}
