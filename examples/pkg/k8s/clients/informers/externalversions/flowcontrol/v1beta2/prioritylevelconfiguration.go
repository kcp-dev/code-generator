...
import (
	...
	flowcontrolv1beta2listers "acme.corp/pkg/kcp/clients/listers/flowcontrol/v1beta2"
)
...
type PriorityLevelConfigurationInformer interface {
	...
	Lister() flowcontrolv1beta2listers.PriorityLevelConfigurationLister
}
...
func (f *priorityLevelConfigurationScopedInformer) Lister() flowcontrolv1beta2listers.PriorityLevelConfigurationLister {
	return flowcontrolv1beta2listers.NewPriorityLevelConfigurationLister(f.Informer().GetIndexer())
}
