...
import (
	...
	flowcontrolv1beta3listers "acme.corp/pkg/kcp/clients/listers/flowcontrol/v1beta3"
)
...
type PriorityLevelConfigurationInformer interface {
	...
	Lister() flowcontrolv1beta3listers.PriorityLevelConfigurationLister
}

func (f *priorityLevelConfigurationClusterInformer) Cluster(clusterName logicalcluster.Name) PriorityLevelConfigurationInformer {
...
func (f *priorityLevelConfigurationInformer) Lister() flowcontrolv1beta3listers.PriorityLevelConfigurationLister {
	return f.lister
}

type priorityLevelConfigurationScopedInformer struct {
	factory          internalinterfaces.SharedScopedInformerFactory
	tweakListOptions internalinterfaces.TweakListOptionsFunc
}

func (f *priorityLevelConfigurationScopedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flowcontrolv1beta3.PriorityLevelConfiguration{}, f.defaultInformer)
}

func (f *priorityLevelConfigurationScopedInformer) Lister() flowcontrolv1beta3listers.PriorityLevelConfigurationLister {
	return flowcontrolv1beta3listers.NewPriorityLevelConfigurationLister(f.Informer().GetIndexer())
}

// NewPriorityLevelConfigurationInformer constructs a new informer for PriorityLevelConfiguration type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewPriorityLevelConfigurationInformer(client scopedclientset.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredPriorityLevelConfigurationInformer(client scopedclientset.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *priorityLevelConfigurationScopedInformer) defaultInformer(client scopedclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredPriorityLevelConfigurationInformer(client, resyncPeriod, cache.Indexers{}, f.tweakListOptions)
}
