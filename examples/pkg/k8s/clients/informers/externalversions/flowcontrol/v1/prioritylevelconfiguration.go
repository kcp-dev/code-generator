...
import (
	...
	flowcontrolv1listers "acme.corp/pkg/kcp/clients/listers/flowcontrol/v1"
)
...
type PriorityLevelConfigurationInformer interface {
	...
	Lister() flowcontrolv1listers.PriorityLevelConfigurationLister
}
...
func (f *priorityLevelConfigurationInformer) Lister() flowcontrolv1listers.PriorityLevelConfigurationLister {
	return f.lister
}
...
func (f *priorityLevelConfigurationScopedInformer) Lister() flowcontrolv1listers.PriorityLevelConfigurationLister {
	return flowcontrolv1listers.NewPriorityLevelConfigurationLister(f.Informer().GetIndexer())
}
