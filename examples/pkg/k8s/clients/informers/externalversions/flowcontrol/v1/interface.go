...
// FlowSchemas returns a FlowSchemaInformer
func (v *scopedVersion) FlowSchemas() FlowSchemaInformer {
	return &flowSchemaScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// PriorityLevelConfigurations returns a PriorityLevelConfigurationInformer
func (v *scopedVersion) PriorityLevelConfigurations() PriorityLevelConfigurationInformer {
	return &priorityLevelConfigurationScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
