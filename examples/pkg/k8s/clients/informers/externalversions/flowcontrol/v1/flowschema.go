...
type FlowSchemaInformer interface {
	...
	Lister() flowcontrolv1listers.FlowSchemaLister
}
...
func (f *flowSchemaInformer) Lister() flowcontrolv1listers.FlowSchemaLister {
	return f.lister
}
...
func (f *flowSchemaScopedInformer) Lister() flowcontrolv1listers.FlowSchemaLister {
	return flowcontrolv1listers.NewFlowSchemaLister(f.Informer().GetIndexer())
}
