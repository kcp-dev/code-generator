...
// EndpointSlices returns a EndpointSliceInformer
func (v *scopedVersion) EndpointSlices() EndpointSliceInformer {
	return &endpointSliceScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
