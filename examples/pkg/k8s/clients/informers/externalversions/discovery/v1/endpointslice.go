...
import (
	...
	discoveryv1listers "acme.corp/pkg/kcp/clients/listers/discovery/v1"
)
...
func (f *endpointSliceScopedInformer) Lister() discoveryv1listers.EndpointSliceLister {
	return discoveryv1listers.NewEndpointSliceLister(f.Informer().GetIndexer())
}
