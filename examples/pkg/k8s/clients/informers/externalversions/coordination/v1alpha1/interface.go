...
// LeaseCandidates returns a LeaseCandidateInformer
func (v *scopedVersion) LeaseCandidates() LeaseCandidateInformer {
	return &leaseCandidateScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
