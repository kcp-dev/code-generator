...
import (
	...
	coordinationv1beta1listers "acme.corp/pkg/kcp/clients/listers/coordination/v1beta1"
)
...
type LeaseInformer interface {
	...
	Lister() coordinationv1beta1listers.LeaseLister
}
...
func (f *leaseScopedInformer) Lister() coordinationv1beta1listers.LeaseLister {
	return coordinationv1beta1listers.NewLeaseLister(f.Informer().GetIndexer())
}
