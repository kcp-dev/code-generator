...
type ControllerRevisionInformer interface {
	...
	Lister() appsv1beta1listers.ControllerRevisionLister
}
...
func (f *controllerRevisionScopedInformer) Lister() appsv1beta1listers.ControllerRevisionLister {
	return appsv1beta1listers.NewControllerRevisionLister(f.Informer().GetIndexer())
}
