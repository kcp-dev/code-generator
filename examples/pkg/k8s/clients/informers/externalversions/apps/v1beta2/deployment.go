...
type DeploymentInformer interface {
	...
	Lister() appsv1beta2listers.DeploymentLister
}
...
func (f *deploymentScopedInformer) Lister() appsv1beta2listers.DeploymentLister {
	return appsv1beta2listers.NewDeploymentLister(f.Informer().GetIndexer())
}
