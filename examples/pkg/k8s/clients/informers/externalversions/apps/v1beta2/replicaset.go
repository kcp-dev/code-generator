...
type ReplicaSetInformer interface {
	...
	Lister() appsv1beta2listers.ReplicaSetLister
}
...
func (f *replicaSetScopedInformer) Lister() appsv1beta2listers.ReplicaSetLister {
	return appsv1beta2listers.NewReplicaSetLister(f.Informer().GetIndexer())
}
