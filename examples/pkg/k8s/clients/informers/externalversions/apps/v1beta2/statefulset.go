...
type StatefulSetInformer interface {
	...
	Lister() appsv1beta2listers.StatefulSetLister
}
...
func (f *statefulSetScopedInformer) Lister() appsv1beta2listers.StatefulSetLister {
	return appsv1beta2listers.NewStatefulSetLister(f.Informer().GetIndexer())
}
