...
import (
	...
	appsv1listers "acme.corp/pkg/kcp/clients/listers/apps/v1"
)
...
func (f *controllerRevisionScopedInformer) Lister() appsv1listers.ControllerRevisionLister {
	return appsv1listers.NewControllerRevisionLister(f.Informer().GetIndexer())
}
