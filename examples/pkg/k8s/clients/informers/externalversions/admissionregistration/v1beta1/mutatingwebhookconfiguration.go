...
type MutatingWebhookConfigurationInformer interface {
	...
	Lister() admissionregistrationv1beta1listers.MutatingWebhookConfigurationLister
}
...
func (f *mutatingWebhookConfigurationScopedInformer) Lister() admissionregistrationv1beta1listers.MutatingWebhookConfigurationLister {
	return admissionregistrationv1beta1listers.NewMutatingWebhookConfigurationLister(f.Informer().GetIndexer())
}
