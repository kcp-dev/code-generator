...
type ValidatingAdmissionPolicyBindingInformer interface {
	...
	Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyBindingLister
}
...
func (f *validatingAdmissionPolicyBindingInformer) Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyBindingLister {
	return f.lister
}
...
func (f *validatingAdmissionPolicyBindingScopedInformer) Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyBindingLister {
	return admissionregistrationv1beta1listers.NewValidatingAdmissionPolicyBindingLister(f.Informer().GetIndexer())
}
