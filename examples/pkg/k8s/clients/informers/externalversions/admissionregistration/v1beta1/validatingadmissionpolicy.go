...
type ValidatingAdmissionPolicyInformer interface {
	...
	Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyLister
}
...
func (f *validatingAdmissionPolicyInformer) Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyLister {
	return f.lister
}
...
func (f *validatingAdmissionPolicyScopedInformer) Lister() admissionregistrationv1beta1listers.ValidatingAdmissionPolicyLister {
	return admissionregistrationv1beta1listers.NewValidatingAdmissionPolicyLister(f.Informer().GetIndexer())
}
