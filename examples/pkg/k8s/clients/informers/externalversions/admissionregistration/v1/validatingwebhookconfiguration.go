...
type ValidatingWebhookConfigurationInformer interface {
	...
	Lister() admissionregistrationv1listers.ValidatingWebhookConfigurationLister
}
...
func (f *validatingWebhookConfigurationScopedInformer) Lister() admissionregistrationv1listers.ValidatingWebhookConfigurationLister {
	return admissionregistrationv1listers.NewValidatingWebhookConfigurationLister(f.Informer().GetIndexer())
}
