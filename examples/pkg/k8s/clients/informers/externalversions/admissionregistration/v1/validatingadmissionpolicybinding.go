...
import (
	...
	admissionregistrationv1listers "acme.corp/pkg/kcp/clients/listers/admissionregistration/v1"
)
...
func (f *validatingAdmissionPolicyBindingInformer) Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyBindingLister {
	return f.lister
}
...
func (f *validatingAdmissionPolicyBindingScopedInformer) Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyBindingLister {
	return admissionregistrationv1listers.NewValidatingAdmissionPolicyBindingLister(f.Informer().GetIndexer())
}
