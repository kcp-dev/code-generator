...
func (f *validatingAdmissionPolicyInformer) Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyLister {
	return f.lister
}
...
func (f *validatingAdmissionPolicyScopedInformer) Lister() admissionregistrationv1listers.ValidatingAdmissionPolicyLister {
	return admissionregistrationv1listers.NewValidatingAdmissionPolicyLister(f.Informer().GetIndexer())
}
