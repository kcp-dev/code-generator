...
type ValidatingAdmissionPolicyInformer interface {
	...
	Lister() admissionregistrationv1alpha1listers.ValidatingAdmissionPolicyLister
}

func (f *validatingAdmissionPolicyClusterInformer) Cluster(clusterName logicalcluster.Name) ValidatingAdmissionPolicyInformer {
...
func (f *validatingAdmissionPolicyInformer) Lister() admissionregistrationv1alpha1listers.ValidatingAdmissionPolicyLister {
	return f.lister
}

type validatingAdmissionPolicyScopedInformer struct {
	factory          internalinterfaces.SharedScopedInformerFactory
	tweakListOptions internalinterfaces.TweakListOptionsFunc
}

func (f *validatingAdmissionPolicyScopedInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&admissionregistrationv1alpha1.ValidatingAdmissionPolicy{}, f.defaultInformer)
}

func (f *validatingAdmissionPolicyScopedInformer) Lister() admissionregistrationv1alpha1listers.ValidatingAdmissionPolicyLister {
	return admissionregistrationv1alpha1listers.NewValidatingAdmissionPolicyLister(f.Informer().GetIndexer())
}

// NewValidatingAdmissionPolicyInformer constructs a new informer for ValidatingAdmissionPolicy type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewValidatingAdmissionPolicyInformer(client scopedclientset.Interface, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredValidatingAdmissionPolicyInformer(client scopedclientset.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
...
func (f *validatingAdmissionPolicyScopedInformer) defaultInformer(client scopedclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredValidatingAdmissionPolicyInformer(client, resyncPeriod, cache.Indexers{}, f.tweakListOptions)
}
