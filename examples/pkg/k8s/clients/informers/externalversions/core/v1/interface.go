...
// PersistentVolumes returns a PersistentVolumeInformer
func (v *scopedVersion) PersistentVolumes() PersistentVolumeInformer {
	return &persistentVolumeScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// PersistentVolumeClaims returns a PersistentVolumeClaimInformer
func (v *scopedVersion) PersistentVolumeClaims() PersistentVolumeClaimInformer {
	return &persistentVolumeClaimScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Pods returns a PodInformer
func (v *scopedVersion) Pods() PodInformer {
	return &podScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// PodTemplates returns a PodTemplateInformer
func (v *scopedVersion) PodTemplates() PodTemplateInformer {
	return &podTemplateScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ReplicationControllers returns a ReplicationControllerInformer
func (v *scopedVersion) ReplicationControllers() ReplicationControllerInformer {
	return &replicationControllerScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Services returns a ServiceInformer
func (v *scopedVersion) Services() ServiceInformer {
	return &serviceScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ServiceAccounts returns a ServiceAccountInformer
func (v *scopedVersion) ServiceAccounts() ServiceAccountInformer {
	return &serviceAccountScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Endpoints returns a EndpointsInformer
func (v *scopedVersion) Endpoints() EndpointsInformer {
	return &endpointsScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Nodes returns a NodeInformer
func (v *scopedVersion) Nodes() NodeInformer {
	return &nodeScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// Namespaces returns a NamespaceInformer
func (v *scopedVersion) Namespaces() NamespaceInformer {
	return &namespaceScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// Events returns a EventInformer
func (v *scopedVersion) Events() EventInformer {
	return &eventScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// LimitRanges returns a LimitRangeInformer
func (v *scopedVersion) LimitRanges() LimitRangeInformer {
	return &limitRangeScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ResourceQuotas returns a ResourceQuotaInformer
func (v *scopedVersion) ResourceQuotas() ResourceQuotaInformer {
	return &resourceQuotaScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// Secrets returns a SecretInformer
func (v *scopedVersion) Secrets() SecretInformer {
	return &secretScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ConfigMaps returns a ConfigMapInformer
func (v *scopedVersion) ConfigMaps() ConfigMapInformer {
	return &configMapScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// ComponentStatuses returns a ComponentStatusInformer
func (v *scopedVersion) ComponentStatuses() ComponentStatusInformer {
	return &componentStatusScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
