...
// PodDisruptionBudgets returns a PodDisruptionBudgetInformer
func (v *scopedVersion) PodDisruptionBudgets() PodDisruptionBudgetInformer {
	return &podDisruptionBudgetScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
