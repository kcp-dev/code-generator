...
import (
	...
	policyv1beta1listers "acme.corp/pkg/kcp/clients/listers/policy/v1beta1"
)
...
func (f *podDisruptionBudgetScopedInformer) Lister() policyv1beta1listers.PodDisruptionBudgetLister {
	return policyv1beta1listers.NewPodDisruptionBudgetLister(f.Informer().GetIndexer())
}
