...
import (
	...
	autoscalingv2beta1listers "acme.corp/pkg/kcp/clients/listers/autoscaling/v2beta1"
)
...
type HorizontalPodAutoscalerInformer interface {
	...
	Lister() autoscalingv2beta1listers.HorizontalPodAutoscalerLister
}
...
func (f *horizontalPodAutoscalerScopedInformer) Lister() autoscalingv2beta1listers.HorizontalPodAutoscalerLister {
	return autoscalingv2beta1listers.NewHorizontalPodAutoscalerLister(f.Informer().GetIndexer())
}
