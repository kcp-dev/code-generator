...
import (
	...
	autoscalingv1listers "acme.corp/pkg/kcp/clients/listers/autoscaling/v1"
)
...
type HorizontalPodAutoscalerInformer interface {
	...
	Lister() autoscalingv1listers.HorizontalPodAutoscalerLister
}
...
func (f *horizontalPodAutoscalerScopedInformer) Lister() autoscalingv1listers.HorizontalPodAutoscalerLister {
	return autoscalingv1listers.NewHorizontalPodAutoscalerLister(f.Informer().GetIndexer())
}
