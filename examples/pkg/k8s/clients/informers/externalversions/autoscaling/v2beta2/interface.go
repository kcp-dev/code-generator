...
// HorizontalPodAutoscalers returns a HorizontalPodAutoscalerInformer
func (v *scopedVersion) HorizontalPodAutoscalers() HorizontalPodAutoscalerInformer {
	return &horizontalPodAutoscalerScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
