...
import (
	...
	autoscalingv2beta2listers "acme.corp/pkg/kcp/clients/listers/autoscaling/v2beta2"
)
...
type HorizontalPodAutoscalerInformer interface {
	...
	Lister() autoscalingv2beta2listers.HorizontalPodAutoscalerLister
}
...
func (f *horizontalPodAutoscalerScopedInformer) Lister() autoscalingv2beta2listers.HorizontalPodAutoscalerLister {
	return autoscalingv2beta2listers.NewHorizontalPodAutoscalerLister(f.Informer().GetIndexer())
}
