...
// Jobs returns a JobInformer
func (v *scopedVersion) Jobs() JobInformer {
	return &jobScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

// CronJobs returns a CronJobInformer
func (v *scopedVersion) CronJobs() CronJobInformer {
	return &cronJobScopedInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
