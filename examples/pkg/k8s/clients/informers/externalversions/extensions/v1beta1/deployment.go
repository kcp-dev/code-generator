...
type DeploymentInformer interface {
	...
	Lister() extensionsv1beta1listers.DeploymentLister
}
...
func (f *deploymentScopedInformer) Lister() extensionsv1beta1listers.DeploymentLister {
	return extensionsv1beta1listers.NewDeploymentLister(f.Informer().GetIndexer())
}
