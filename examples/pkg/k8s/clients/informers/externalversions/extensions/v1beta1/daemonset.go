...
type DaemonSetInformer interface {
	...
	Lister() extensionsv1beta1listers.DaemonSetLister
}
...
func (f *daemonSetScopedInformer) Lister() extensionsv1beta1listers.DaemonSetLister {
	return extensionsv1beta1listers.NewDaemonSetLister(f.Informer().GetIndexer())
}
