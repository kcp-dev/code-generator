...
// ClusterTrustBundles returns a ClusterTrustBundleInformer
func (v *scopedVersion) ClusterTrustBundles() ClusterTrustBundleInformer {
	return &clusterTrustBundleScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
