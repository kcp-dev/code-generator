...
// CertificateSigningRequests returns a CertificateSigningRequestInformer
func (v *scopedVersion) CertificateSigningRequests() CertificateSigningRequestInformer {
	return &certificateSigningRequestScopedInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
