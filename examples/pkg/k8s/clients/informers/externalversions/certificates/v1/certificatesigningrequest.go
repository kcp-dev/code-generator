...
import (
	...
	certificatesv1listers "acme.corp/pkg/kcp/clients/listers/certificates/v1"
)
...
func (f *certificateSigningRequestScopedInformer) Lister() certificatesv1listers.CertificateSigningRequestLister {
	return certificatesv1listers.NewCertificateSigningRequestLister(f.Informer().GetIndexer())
}
