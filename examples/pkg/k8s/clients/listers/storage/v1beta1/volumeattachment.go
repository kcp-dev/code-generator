...
// List lists all VolumeAttachments in the indexer for a workspace.
func (s *volumeAttachmentScopedLister) List(selector labels.Selector) (ret []*storagev1beta1.VolumeAttachment, err error) {
...
// Get retrieves the VolumeAttachment from the indexer for a given workspace and name.
func (s *volumeAttachmentScopedLister) Get(name string) (*storagev1beta1.VolumeAttachment, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
