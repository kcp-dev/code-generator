...
// List lists all CSIStorageCapacities in the indexer for a workspace.
func (s *cSIStorageCapacityScopedLister) List(selector labels.Selector) (ret []*storagev1alpha1.CSIStorageCapacity, err error) {
...
// List lists all CSIStorageCapacities in the indexer for a given workspace and namespace.
func (s *cSIStorageCapacityScopedNamespaceLister) List(selector labels.Selector) (ret []*storagev1alpha1.CSIStorageCapacity, err error) {
...
// Get retrieves the CSIStorageCapacity from the indexer for a given workspace, namespace and name.
func (s *cSIStorageCapacityScopedNamespaceLister) Get(name string) (*storagev1alpha1.CSIStorageCapacity, error) {
