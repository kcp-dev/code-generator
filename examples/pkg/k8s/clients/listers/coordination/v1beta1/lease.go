...
// List lists all Leases in the indexer for a workspace.
func (s *leaseScopedLister) List(selector labels.Selector) (ret []*coordinationv1beta1.Lease, err error) {
...
// List lists all Leases in the indexer for a given workspace and namespace.
func (s *leaseScopedNamespaceLister) List(selector labels.Selector) (ret []*coordinationv1beta1.Lease, err error) {
...
// Get retrieves the Lease from the indexer for a given workspace, namespace and name.
func (s *leaseScopedNamespaceLister) Get(name string) (*coordinationv1beta1.Lease, error) {
