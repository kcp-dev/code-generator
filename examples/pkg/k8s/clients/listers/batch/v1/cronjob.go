...
// List lists all CronJobs in the indexer for a workspace.
func (s *cronJobScopedLister) List(selector labels.Selector) (ret []*batchv1.CronJob, err error) {
...
// List lists all CronJobs in the indexer for a given workspace and namespace.
func (s *cronJobScopedNamespaceLister) List(selector labels.Selector) (ret []*batchv1.CronJob, err error) {
...
// Get retrieves the CronJob from the indexer for a given workspace, namespace and name.
func (s *cronJobScopedNamespaceLister) Get(name string) (*batchv1.CronJob, error) {
