...
type ResourceClaimNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*resourcev1alpha2.ResourceClaim, error)
...
// List lists all ResourceClaims in the indexer for a workspace.
func (s *resourceClaimScopedLister) List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error) {
...
// List lists all ResourceClaims in the indexer for a given workspace and namespace.
func (s *resourceClaimScopedNamespaceLister) List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error) {
...
// Get retrieves the ResourceClaim from the indexer for a given workspace, namespace and name.
func (s *resourceClaimScopedNamespaceLister) Get(name string) (*resourcev1alpha2.ResourceClaim, error) {
