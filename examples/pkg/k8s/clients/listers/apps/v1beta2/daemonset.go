...
// List lists all DaemonSets in the indexer for a workspace.
func (s *daemonSetScopedLister) List(selector labels.Selector) (ret []*appsv1beta2.DaemonSet, err error) {
...
// List lists all DaemonSets in the indexer for a given workspace and namespace.
func (s *daemonSetScopedNamespaceLister) List(selector labels.Selector) (ret []*appsv1beta2.DaemonSet, err error) {
...
// Get retrieves the DaemonSet from the indexer for a given workspace, namespace and name.
func (s *daemonSetScopedNamespaceLister) Get(name string) (*appsv1beta2.DaemonSet, error) {
