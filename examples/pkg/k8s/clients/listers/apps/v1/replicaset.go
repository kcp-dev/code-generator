...
// List lists all ReplicaSets in the indexer for a workspace.
func (s *replicaSetScopedLister) List(selector labels.Selector) (ret []*appsv1.ReplicaSet, err error) {
...
// List lists all ReplicaSets in the indexer for a given workspace and namespace.
func (s *replicaSetScopedNamespaceLister) List(selector labels.Selector) (ret []*appsv1.ReplicaSet, err error) {
...
// Get retrieves the ReplicaSet from the indexer for a given workspace, namespace and name.
func (s *replicaSetScopedNamespaceLister) Get(name string) (*appsv1.ReplicaSet, error) {
