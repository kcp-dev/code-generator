...
// List lists all Deployments in the indexer for a workspace.
func (s *deploymentScopedLister) List(selector labels.Selector) (ret []*appsv1.Deployment, err error) {
...
// List lists all Deployments in the indexer for a given workspace and namespace.
func (s *deploymentScopedNamespaceLister) List(selector labels.Selector) (ret []*appsv1.Deployment, err error) {
...
// Get retrieves the Deployment from the indexer for a given workspace, namespace and name.
func (s *deploymentScopedNamespaceLister) Get(name string) (*appsv1.Deployment, error) {
