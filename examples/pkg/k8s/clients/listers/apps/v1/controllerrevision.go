...
// List lists all ControllerRevisions in the indexer for a workspace.
func (s *controllerRevisionScopedLister) List(selector labels.Selector) (ret []*appsv1.ControllerRevision, err error) {
...
// List lists all ControllerRevisions in the indexer for a given workspace and namespace.
func (s *controllerRevisionScopedNamespaceLister) List(selector labels.Selector) (ret []*appsv1.ControllerRevision, err error) {
...
// Get retrieves the ControllerRevision from the indexer for a given workspace, namespace and name.
func (s *controllerRevisionScopedNamespaceLister) Get(name string) (*appsv1.ControllerRevision, error) {
