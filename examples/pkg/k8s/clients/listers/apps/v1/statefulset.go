...
// List lists all StatefulSets in the indexer for a workspace.
func (s *statefulSetScopedLister) List(selector labels.Selector) (ret []*appsv1.StatefulSet, err error) {
...
// List lists all StatefulSets in the indexer for a given workspace and namespace.
func (s *statefulSetScopedNamespaceLister) List(selector labels.Selector) (ret []*appsv1.StatefulSet, err error) {
...
// Get retrieves the StatefulSet from the indexer for a given workspace, namespace and name.
func (s *statefulSetScopedNamespaceLister) Get(name string) (*appsv1.StatefulSet, error) {
