...
// List lists all Events in the indexer for a workspace.
func (s *eventScopedLister) List(selector labels.Selector) (ret []*corev1.Event, err error) {
...
// List lists all Events in the indexer for a given workspace and namespace.
func (s *eventScopedNamespaceLister) List(selector labels.Selector) (ret []*corev1.Event, err error) {
...
// Get retrieves the Event from the indexer for a given workspace, namespace and name.
func (s *eventScopedNamespaceLister) Get(name string) (*corev1.Event, error) {
