...
// ReplicaSetLister can list ReplicaSets across all namespaces, or scope down to a ReplicaSetNamespaceLister for one namespace.
// All objects returned here must be treated as read-only.
type ReplicaSetLister interface {
	// List lists all ReplicaSets in the workspace.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*extensionsv1beta1.ReplicaSet, err error)
	// ReplicaSets returns a lister that can list and get ReplicaSets in one workspace and namespace.
	ReplicaSets(namespace string) ReplicaSetNamespaceLister
	ReplicaSetListerExpansion
}

// replicaSetLister can list all ReplicaSets inside a workspace or scope down to a ReplicaSetLister for one namespace.
...
type ReplicaSetNamespaceLister interface {
	// List lists all ReplicaSets in the workspace and namespace.
	// Objects returned here must be treated as read-only.
	List(selector labels.Selector) (ret []*extensionsv1beta1.ReplicaSet, err error)
...
func NewReplicaSetLister(indexer cache.Indexer) *replicaSetScopedLister {
	return &replicaSetScopedLister{indexer: indexer}
}

// replicaSetScopedLister can list all ReplicaSets inside a workspace or scope down to a ReplicaSetLister for one namespace.
type replicaSetScopedLister struct {
	indexer cache.Indexer
}

// List lists all ReplicaSets in the indexer for a workspace.
func (s *replicaSetScopedLister) List(selector labels.Selector) (ret []*extensionsv1beta1.ReplicaSet, err error) {
...
// ReplicaSets returns an object that can list and get ReplicaSets in one namespace.
func (s *replicaSetScopedLister) ReplicaSets(namespace string) ReplicaSetNamespaceLister {
	return &replicaSetScopedNamespaceLister{indexer: s.indexer, namespace: namespace}
}

// replicaSetScopedNamespaceLister helps list and get ReplicaSets.
type replicaSetScopedNamespaceLister struct {
	indexer   cache.Indexer
	namespace string
}

// List lists all ReplicaSets in the indexer for a given workspace and namespace.
func (s *replicaSetScopedNamespaceLister) List(selector labels.Selector) (ret []*extensionsv1beta1.ReplicaSet, err error) {
...
// Get retrieves the ReplicaSet from the indexer for a given workspace, namespace and name.
func (s *replicaSetScopedNamespaceLister) Get(name string) (*extensionsv1beta1.ReplicaSet, error) {
