...
// List lists all PodDisruptionBudgets in the indexer for a workspace.
func (s *podDisruptionBudgetScopedLister) List(selector labels.Selector) (ret []*policyv1beta1.PodDisruptionBudget, err error) {
...
// List lists all PodDisruptionBudgets in the indexer for a given workspace and namespace.
func (s *podDisruptionBudgetScopedNamespaceLister) List(selector labels.Selector) (ret []*policyv1beta1.PodDisruptionBudget, err error) {
...
// Get retrieves the PodDisruptionBudget from the indexer for a given workspace, namespace and name.
func (s *podDisruptionBudgetScopedNamespaceLister) Get(name string) (*policyv1beta1.PodDisruptionBudget, error) {
