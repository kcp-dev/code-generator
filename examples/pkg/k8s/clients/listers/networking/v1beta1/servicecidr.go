...
// List lists all ServiceCIDRs in the indexer for a workspace.
func (s *serviceCIDRScopedLister) List(selector labels.Selector) (ret []*networkingv1beta1.ServiceCIDR, err error) {
...
// Get retrieves the ServiceCIDR from the indexer for a given workspace and name.
func (s *serviceCIDRScopedLister) Get(name string) (*networkingv1beta1.ServiceCIDR, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
