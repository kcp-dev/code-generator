...
// List lists all Ingresses in the indexer for a workspace.
func (s *ingressScopedLister) List(selector labels.Selector) (ret []*networkingv1beta1.Ingress, err error) {
...
// List lists all Ingresses in the indexer for a given workspace and namespace.
func (s *ingressScopedNamespaceLister) List(selector labels.Selector) (ret []*networkingv1beta1.Ingress, err error) {
...
// Get retrieves the Ingress from the indexer for a given workspace, namespace and name.
func (s *ingressScopedNamespaceLister) Get(name string) (*networkingv1beta1.Ingress, error) {
