...
// List lists all NetworkPolicies in the indexer for a workspace.
func (s *networkPolicyScopedLister) List(selector labels.Selector) (ret []*networkingv1.NetworkPolicy, err error) {
...
// List lists all NetworkPolicies in the indexer for a given workspace and namespace.
func (s *networkPolicyScopedNamespaceLister) List(selector labels.Selector) (ret []*networkingv1.NetworkPolicy, err error) {
...
// Get retrieves the NetworkPolicy from the indexer for a given workspace, namespace and name.
func (s *networkPolicyScopedNamespaceLister) Get(name string) (*networkingv1.NetworkPolicy, error) {
