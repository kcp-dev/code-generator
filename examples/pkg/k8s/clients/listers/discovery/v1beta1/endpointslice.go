...
// List lists all EndpointSlices in the indexer for a workspace.
func (s *endpointSliceScopedLister) List(selector labels.Selector) (ret []*discoveryv1beta1.EndpointSlice, err error) {
...
// List lists all EndpointSlices in the indexer for a given workspace and namespace.
func (s *endpointSliceScopedNamespaceLister) List(selector labels.Selector) (ret []*discoveryv1beta1.EndpointSlice, err error) {
...
// Get retrieves the EndpointSlice from the indexer for a given workspace, namespace and name.
func (s *endpointSliceScopedNamespaceLister) Get(name string) (*discoveryv1beta1.EndpointSlice, error) {
