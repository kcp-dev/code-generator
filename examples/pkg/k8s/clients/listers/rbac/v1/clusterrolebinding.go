...
// List lists all ClusterRoleBindings in the indexer for a workspace.
func (s *clusterRoleBindingScopedLister) List(selector labels.Selector) (ret []*rbacv1.ClusterRoleBinding, err error) {
...
// Get retrieves the ClusterRoleBinding from the indexer for a given workspace and name.
func (s *clusterRoleBindingScopedLister) Get(name string) (*rbacv1.ClusterRoleBinding, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
