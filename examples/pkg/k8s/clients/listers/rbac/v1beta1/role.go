...
// List lists all Roles in the indexer for a workspace.
func (s *roleScopedLister) List(selector labels.Selector) (ret []*rbacv1beta1.Role, err error) {
...
// List lists all Roles in the indexer for a given workspace and namespace.
func (s *roleScopedNamespaceLister) List(selector labels.Selector) (ret []*rbacv1beta1.Role, err error) {
...
// Get retrieves the Role from the indexer for a given workspace, namespace and name.
func (s *roleScopedNamespaceLister) Get(name string) (*rbacv1beta1.Role, error) {
