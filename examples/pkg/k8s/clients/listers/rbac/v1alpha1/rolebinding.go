...
// List lists all RoleBindings in the indexer for a workspace.
func (s *roleBindingScopedLister) List(selector labels.Selector) (ret []*rbacv1alpha1.RoleBinding, err error) {
...
// List lists all RoleBindings in the indexer for a given workspace and namespace.
func (s *roleBindingScopedNamespaceLister) List(selector labels.Selector) (ret []*rbacv1alpha1.RoleBinding, err error) {
...
// Get retrieves the RoleBinding from the indexer for a given workspace, namespace and name.
func (s *roleBindingScopedNamespaceLister) Get(name string) (*rbacv1alpha1.RoleBinding, error) {
