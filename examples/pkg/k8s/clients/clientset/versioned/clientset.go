...
import (
	...
	admissionregistrationv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/admissionregistration/v1"
	admissionregistrationv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/admissionregistration/v1alpha1"
	admissionregistrationv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/admissionregistration/v1beta1"
	internalv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/apiserverinternal/v1alpha1"
	appsv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/apps/v1"
	appsv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/apps/v1beta1"
	appsv1beta2 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/apps/v1beta2"
	authenticationv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/authentication/v1"
	authenticationv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/authentication/v1alpha1"
	authenticationv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/authentication/v1beta1"
	authorizationv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/authorization/v1"
	authorizationv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/authorization/v1beta1"
	autoscalingv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/autoscaling/v1"
	autoscalingv2 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/autoscaling/v2"
	autoscalingv2beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/autoscaling/v2beta1"
	autoscalingv2beta2 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/autoscaling/v2beta2"
	batchv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/batch/v1"
	batchv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/batch/v1beta1"
	certificatesv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/certificates/v1"
	certificatesv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/certificates/v1alpha1"
	certificatesv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/certificates/v1beta1"
	coordinationv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/coordination/v1"
	coordinationv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/coordination/v1alpha1"
	coordinationv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/coordination/v1beta1"
	corev1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/core/v1"
	discoveryv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/discovery/v1"
	discoveryv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/discovery/v1beta1"
	eventsv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/events/v1"
	eventsv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/events/v1beta1"
	extensionsv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/extensions/v1beta1"
	flowcontrolv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/flowcontrol/v1"
	flowcontrolv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/flowcontrol/v1beta1"
	flowcontrolv1beta2 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/flowcontrol/v1beta2"
	flowcontrolv1beta3 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/flowcontrol/v1beta3"
	networkingv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/networking/v1"
	networkingv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/networking/v1alpha1"
	networkingv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/networking/v1beta1"
	nodev1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/node/v1"
	nodev1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/node/v1alpha1"
	nodev1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/node/v1beta1"
	policyv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/policy/v1"
	policyv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/policy/v1beta1"
	rbacv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/rbac/v1"
	rbacv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/rbac/v1alpha1"
	rbacv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/rbac/v1beta1"
	resourcev1alpha3 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/resource/v1alpha3"
	schedulingv1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/scheduling/v1"
	schedulingv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/scheduling/v1alpha1"
	schedulingv1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/scheduling/v1beta1"
	storagev1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/storage/v1"
	storagev1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/storage/v1alpha1"
	storagev1beta1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/storage/v1beta1"
	storagemigrationv1alpha1 "acme.corp/pkg/k8s/clients/clientset/versioned/typed/storagemigration/v1alpha1"
)
