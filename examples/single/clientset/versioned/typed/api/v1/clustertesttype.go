...
type ClusterTestTypeClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamexamplev1client.ClusterTestTypeInterface
...
func (c *clusterTestTypesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamexamplev1client.ClusterTestTypeInterface {
...
func (c *clusterTestTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*apiv1.ClusterTestTypeList, error) {
