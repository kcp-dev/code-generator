...
import (
	...
	kcp "k8s.io/code-generator/examples/crd/clientset/versioned/typed/example/v1"
)
...
func (c *clusterTestTypesClient) ApplyScale(ctx context.Context, deploymentName string, applyConfiguration *examplev1.ClusterTestTypeApplyConfiguration, opts metav1.ApplyOptions) (*v1.ClusterTestType, error) {
	if applyConfiguration == nil
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
