...
import (
	...
	kcp "k8s.io/code-generator/examples/crd/clientset/versioned/typed/example2/v1"
)
...
func (n *testTypesNamespacer) Namespace(namespace string) upstreamsecondexamplev1client.TestTypeInterface {
...
func (c *testTypesClient) Apply(ctx context.Context, applyConfiguration *example2v1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (*v1.TestType, error) {
...
func (c *testTypesClient) ApplyStatus(ctx context.Context, applyConfiguration *example2v1.TestTypeApplyConfiguration, opts metav1.ApplyOptions) (*v1.TestType, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
