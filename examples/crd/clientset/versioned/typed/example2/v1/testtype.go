...
type testTypesClusterInterface struct {
	clientCache kcpclient.Cache[*SecondExampleV1Client]
}
...
func (c *testTypesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*example2v1.TestTypeList, error) {
