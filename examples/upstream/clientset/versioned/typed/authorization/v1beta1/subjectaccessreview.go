...
func (c *subjectAccessReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamauthorizationv1beta1client.SubjectAccessReviewInterface {
...
func (c *subjectAccessReviewsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.SubjectAccessReviewList, error) {
