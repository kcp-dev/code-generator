...
func (c *selfSubjectRulesReviewsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamauthorizationv1beta1client.SelfSubjectRulesReviewInterface {
...
func (c *selfSubjectRulesReviewsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.SelfSubjectRulesReviewList, error) {
