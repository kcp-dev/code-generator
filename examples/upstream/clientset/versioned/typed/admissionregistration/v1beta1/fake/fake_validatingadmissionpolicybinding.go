...
func (c *validatingAdmissionPolicyBindingsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ValidatingAdmissionPolicyBinding, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(validatingadmissionpolicybindingsResource, c.ClusterPath, c.Namespace, name), &v1beta1.ValidatingAdmissionPolicyBinding{})
	if obj == nil {
		return nil, err
	}
...
func (c *validatingAdmissionPolicyBindingsClusterClient) Create(ctx context.Context, validatingAdmissionPolicyBinding *v1beta1.ValidatingAdmissionPolicyBinding, opts v1.CreateOptions) (result *v1beta1.ValidatingAdmissionPolicyBinding, err error) {
...
func (c *validatingAdmissionPolicyBindingsClusterClient) Update(ctx context.Context, validatingAdmissionPolicyBinding *v1beta1.ValidatingAdmissionPolicyBinding, opts v1.UpdateOptions) (result *v1beta1.ValidatingAdmissionPolicyBinding, err error) {
	emptyResult := &v1beta1.ValidatingAdmissionPolicyBinding{}
	obj, err := c.Fake.
...
func (c *validatingAdmissionPolicyBindingsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ValidatingAdmissionPolicyBinding, err error) {
	emptyResult := &v1beta1.ValidatingAdmissionPolicyBinding{}
	obj, err := c.Fake.
...
func (c *validatingAdmissionPolicyBindingsClusterClient) Apply(ctx context.Context, validatingAdmissionPolicyBinding *admissionregistrationv1beta1.ValidatingAdmissionPolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ValidatingAdmissionPolicyBinding, err error) {
