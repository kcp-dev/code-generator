...
type ValidatingAdmissionPolicyClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1beta1client.ValidatingAdmissionPolicyInterface
...
func (c *validatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamadmissionregistrationv1beta1client.ValidatingAdmissionPolicyInterface {
...
func (c *validatingAdmissionPoliciesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.ValidatingAdmissionPolicyList, error) {
