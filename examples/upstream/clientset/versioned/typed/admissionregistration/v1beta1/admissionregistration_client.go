...
type AdmissionregistrationV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1beta1client.AdmissionregistrationV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AdmissionregistrationV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamadmissionregistrationv1beta1client.AdmissionregistrationV1beta1Client]{
		NewForConfigAndClient: upstreamadmissionregistrationv1beta1client.NewForConfigAndClient,
	})
