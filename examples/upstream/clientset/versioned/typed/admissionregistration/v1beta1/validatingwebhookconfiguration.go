...
type ValidatingWebhookConfigurationClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1beta1client.ValidatingWebhookConfigurationInterface
...
func (c *validatingWebhookConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamadmissionregistrationv1beta1client.ValidatingWebhookConfigurationInterface {
...
func (c *validatingWebhookConfigurationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.ValidatingWebhookConfigurationList, error) {
