...
type AdmissionregistrationV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1alpha1client.AdmissionregistrationV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AdmissionregistrationV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamadmissionregistrationv1alpha1client.AdmissionregistrationV1alpha1Client]{
		NewForConfigAndClient: upstreamadmissionregistrationv1alpha1client.NewForConfigAndClient,
	})
