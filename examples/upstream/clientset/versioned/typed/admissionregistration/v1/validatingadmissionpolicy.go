...
type ValidatingAdmissionPolicyClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1client.ValidatingAdmissionPolicyInterface
...
func (c *validatingAdmissionPoliciesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamadmissionregistrationv1client.ValidatingAdmissionPolicyInterface {
