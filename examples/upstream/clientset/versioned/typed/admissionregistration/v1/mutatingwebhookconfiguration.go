...
type MutatingWebhookConfigurationClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamadmissionregistrationv1client.MutatingWebhookConfigurationInterface
...
func (c *mutatingWebhookConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamadmissionregistrationv1client.MutatingWebhookConfigurationInterface {
