...
// List returns the entire collection of all Endpoints that are available in all clusters.
...
// EndpointsNamespacer can scope to objects within a namespace, returning a EndpointsInterface.
type EndpointsNamespacer interface {
	Namespace(name string) upstreamcorev1client.EndpointsInterface
}
