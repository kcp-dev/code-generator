...
func (c *podTemplatesClusterInterface) Cluster(clusterPath logicalcluster.Path) PodTemplateNamespacer {
...
// List returns the entire collection of all PodTemplates that are available in all clusters.
...
// PodTemplateNamespacer can scope to objects within a namespace, returning a PodTemplateInterface.
type PodTemplateNamespacer interface {
	Namespace(name string) upstreamcorev1client.PodTemplateInterface
}
