...
func (c *persistentVolumeClaimsClusterInterface) Cluster(clusterPath logicalcluster.Path) PersistentVolumeClaimNamespacer {
...
// List returns the entire collection of all PersistentVolumeClaims that are available in all clusters.
...
// PersistentVolumeClaimNamespacer can scope to objects within a namespace, returning a PersistentVolumeClaimInterface.
type PersistentVolumeClaimNamespacer interface {
	Namespace(name string) upstreamcorev1client.PersistentVolumeClaimInterface
}
