...
func (c *horizontalPodAutoscalersClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v2.HorizontalPodAutoscalerList, error) {
...
type HorizontalPodAutoscalerNamespacer interface {
	Namespace(name string) upstreamautoscalingv2client.HorizontalPodAutoscalerInterface
}
