...
func (c *horizontalPodAutoscalersClient) Update(ctx context.Context, horizontalPodAutoscaler *v2.HorizontalPodAutoscaler, opts metav1.CreateOptions) (*v2.HorizontalPodAutoscaler, error) {
...
func (c *horizontalPodAutoscalersClient) UpdateStatus(ctx context.Context, horizontalPodAutoscaler *v2.HorizontalPodAutoscaler, opts metav1.CreateOptions) (*v2.HorizontalPodAutoscaler, error) {
...
// List takes label and field selectors, and returns the list of v2.HorizontalPodAutoscaler that match those selectors.
