...
type AutoscalingV1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamautoscalingv1client.AutoscalingV1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AutoscalingV1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamautoscalingv1client.AutoscalingV1Client]{
		NewForConfigAndClient: upstreamautoscalingv1client.NewForConfigAndClient,
	})
