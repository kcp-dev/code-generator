...
func (c *horizontalPodAutoscalersClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v2beta1.HorizontalPodAutoscalerList, error) {
...
type HorizontalPodAutoscalerNamespacer interface {
	Namespace(name string) upstreamautoscalingv2beta1client.HorizontalPodAutoscalerInterface
}
