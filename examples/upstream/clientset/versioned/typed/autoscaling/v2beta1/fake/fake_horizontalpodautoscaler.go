...
func (c *horizontalPodAutoscalersClient) ApplyStatus(ctx context.Context, applyConfiguration *autoscalingv2beta1.HorizontalPodAutoscalerApplyConfiguration, opts metav1.ApplyOptions) (*v2beta1.HorizontalPodAutoscaler, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(horizontalpodautoscalersResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v2beta1.HorizontalPodAutoscaler{})
