...
type RuntimeClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamnodev1client.RuntimeClassInterface
...
func (c *runtimeClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamnodev1client.RuntimeClassInterface {
