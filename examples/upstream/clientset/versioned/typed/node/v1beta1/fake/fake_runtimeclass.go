...
func (c *runtimeClassesClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.RuntimeClass, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(runtimeclassesResource, c.ClusterPath, c.Namespace, name), &v1beta1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *runtimeClassesClusterClient) Create(ctx context.Context, runtimeClass *v1beta1.RuntimeClass, opts v1.CreateOptions) (result *v1beta1.RuntimeClass, err error) {
...
func (c *runtimeClassesClusterClient) Update(ctx context.Context, runtimeClass *v1beta1.RuntimeClass, opts v1.UpdateOptions) (result *v1beta1.RuntimeClass, err error) {
	emptyResult := &v1beta1.RuntimeClass{}
	obj, err := c.Fake.
...
func (c *runtimeClassesClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.RuntimeClass, err error) {
	emptyResult := &v1beta1.RuntimeClass{}
	obj, err := c.Fake.
...
func (c *runtimeClassesClusterClient) Apply(ctx context.Context, runtimeClass *nodev1beta1.RuntimeClassApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.RuntimeClass, err error) {
	if runtimeClass == nil {
