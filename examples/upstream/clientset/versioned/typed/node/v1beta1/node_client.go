...
type NodeV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamnodev1beta1client.NodeV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NodeV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamnodev1beta1client.NodeV1beta1Client]{
		NewForConfigAndClient: upstreamnodev1beta1client.NewForConfigAndClient,
	})
