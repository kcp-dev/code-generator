...
type NodeV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamnodev1alpha1client.NodeV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NodeV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamnodev1alpha1client.NodeV1alpha1Client]{
		NewForConfigAndClient: upstreamnodev1alpha1client.NewForConfigAndClient,
	})
