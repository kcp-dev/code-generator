...
func (c *runtimeClassesClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RuntimeClass, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(runtimeclassesResource, c.ClusterPath, c.Namespace, name), &v1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *runtimeClassesClusterClient) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *runtimeClassesClusterClient) Create(ctx context.Context, runtimeClass *v1alpha1.RuntimeClass, opts v1.CreateOptions) (result *v1alpha1.RuntimeClass, err error) {
...
func (c *runtimeClassesClusterClient) Update(ctx context.Context, runtimeClass *v1alpha1.RuntimeClass, opts v1.UpdateOptions) (result *v1alpha1.RuntimeClass, err error) {
	emptyResult := &v1alpha1.RuntimeClass{}
	obj, err := c.Fake.
...
func (c *runtimeClassesClusterClient) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *runtimeClassesClusterClient) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *runtimeClassesClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RuntimeClass, err error) {
	emptyResult := &v1alpha1.RuntimeClass{}
	obj, err := c.Fake.
...
func (c *runtimeClassesClusterClient) Apply(ctx context.Context, runtimeClass *nodev1alpha1.RuntimeClassApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.RuntimeClass, err error) {
	if runtimeClass == nil {
