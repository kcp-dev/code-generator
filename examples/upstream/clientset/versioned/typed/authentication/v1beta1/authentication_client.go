...
type AuthenticationV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamauthenticationv1beta1client.AuthenticationV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthenticationV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamauthenticationv1beta1client.AuthenticationV1beta1Client]{
		NewForConfigAndClient: upstreamauthenticationv1beta1client.NewForConfigAndClient,
	})
