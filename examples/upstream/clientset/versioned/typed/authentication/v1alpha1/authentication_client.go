...
type AuthenticationV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamauthenticationv1alpha1client.AuthenticationV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthenticationV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamauthenticationv1alpha1client.AuthenticationV1alpha1Client]{
		NewForConfigAndClient: upstreamauthenticationv1alpha1client.NewForConfigAndClient,
	})
