...
type AuthenticationV1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamauthenticationv1client.AuthenticationV1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AuthenticationV1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamauthenticationv1client.AuthenticationV1Client]{
		NewForConfigAndClient: upstreamauthenticationv1client.NewForConfigAndClient,
	})
