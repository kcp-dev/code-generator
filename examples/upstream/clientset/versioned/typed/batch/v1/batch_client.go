...
type BatchV1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreambatchv1client.BatchV1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BatchV1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreambatchv1client.BatchV1Client]{
		NewForConfigAndClient: upstreambatchv1client.NewForConfigAndClient,
	})
