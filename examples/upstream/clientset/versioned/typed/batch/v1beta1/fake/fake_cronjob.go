...
func (c *cronJobsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CronJob, err error) {
...
func (c *cronJobsClusterClient) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *cronJobsClusterClient) Create(ctx context.Context, cronJob *v1beta1.CronJob, opts v1.CreateOptions) (result *v1beta1.CronJob, err error) {
...
func (c *cronJobsClusterClient) Update(ctx context.Context, cronJob *v1beta1.CronJob, opts v1.UpdateOptions) (result *v1beta1.CronJob, err error) {
	emptyResult := &v1beta1.CronJob{}
	obj, err := c.Fake.
...
func (c *cronJobsClusterClient) UpdateStatus(ctx context.Context, cronJob *v1beta1.CronJob, opts v1.UpdateOptions) (result *v1beta1.CronJob, err error) {
	emptyResult := &v1beta1.CronJob{}
	obj, err := c.Fake.
...
func (c *cronJobsClusterClient) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *cronJobsClusterClient) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *cronJobsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CronJob, err error) {
	emptyResult := &v1beta1.CronJob{}
	obj, err := c.Fake.
...
func (c *cronJobsClusterClient) Apply(ctx context.Context, cronJob *batchv1beta1.CronJobApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.CronJob, err error) {
	if cronJob == nil {
...
func (c *cronJobsClusterClient) ApplyStatus(ctx context.Context, cronJob *batchv1beta1.CronJobApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.CronJob, err error) {
	if cronJob == nil {
		return nil, fmt.Errorf("cronJob provided to Apply must not be nil")
	}
	data, err := json.Marshal(cronJob)
