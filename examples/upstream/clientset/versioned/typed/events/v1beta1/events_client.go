...
type EventsV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreameventsv1beta1client.EventsV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*EventsV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreameventsv1beta1client.EventsV1beta1Client]{
		NewForConfigAndClient: upstreameventsv1beta1client.NewForConfigAndClient,
	})
