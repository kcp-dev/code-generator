...
func (c *eventsClusterClient) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.EventList, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(eventsResource, eventsKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &v1beta1.EventList{})
	if obj == nil {
		return nil, err
	}
...
func (c *eventsClient) Apply(ctx context.Context, applyConfiguration *eventsv1beta1.EventApplyConfiguration, opts metav1.ApplyOptions) (*v1beta1.Event, error) {
