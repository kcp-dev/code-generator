...
func (c *eventsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Event, err error) {
...
func (c *eventsClusterClient) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.EventList, err error) {
...
func (c *eventsClusterClient) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *eventsClusterClient) Create(ctx context.Context, event *v1beta1.Event, opts v1.CreateOptions) (result *v1beta1.Event, err error) {
...
func (c *eventsClusterClient) Update(ctx context.Context, event *v1beta1.Event, opts v1.UpdateOptions) (result *v1beta1.Event, err error) {
	emptyResult := &v1beta1.Event{}
	obj, err := c.Fake.
...
func (c *eventsClusterClient) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *eventsClusterClient) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *eventsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Event, err error) {
	emptyResult := &v1beta1.Event{}
	obj, err := c.Fake.
...
func (c *eventsClusterClient) Apply(ctx context.Context, event *eventsv1beta1.EventApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.Event, err error) {
	if event == nil {
