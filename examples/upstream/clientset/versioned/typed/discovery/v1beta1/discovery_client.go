...
type DiscoveryV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamdiscoveryv1beta1client.DiscoveryV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DiscoveryV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamdiscoveryv1beta1client.DiscoveryV1beta1Client]{
		NewForConfigAndClient: upstreamdiscoveryv1beta1client.NewForConfigAndClient,
	})
