...
type FlowSchemaClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta1client.FlowSchemaInterface
	FlowSchemaExpansion
}
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1beta1client.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.FlowSchemaList, error) {
