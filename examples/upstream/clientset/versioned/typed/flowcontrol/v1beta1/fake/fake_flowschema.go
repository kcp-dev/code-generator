...
func (c *flowSchemasClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.FlowSchema, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(flowschemasResource, c.ClusterPath, c.Namespace, name), &v1beta1.FlowSchema{})
	if obj == nil {
		return nil, err
	}
...
func (c *flowSchemasClusterClient) Create(ctx context.Context, flowSchema *v1beta1.FlowSchema, opts v1.CreateOptions) (result *v1beta1.FlowSchema, err error) {
...
func (c *flowSchemasClusterClient) Update(ctx context.Context, flowSchema *v1beta1.FlowSchema, opts v1.UpdateOptions) (result *v1beta1.FlowSchema, err error) {
	emptyResult := &v1beta1.FlowSchema{}
	obj, err := c.Fake.
...
func (c *flowSchemasClusterClient) UpdateStatus(ctx context.Context, flowSchema *v1beta1.FlowSchema, opts v1.UpdateOptions) (result *v1beta1.FlowSchema, err error) {
	emptyResult := &v1beta1.FlowSchema{}
	obj, err := c.Fake.
...
func (c *flowSchemasClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.FlowSchema, err error) {
	emptyResult := &v1beta1.FlowSchema{}
	obj, err := c.Fake.
...
func (c *flowSchemasClusterClient) Apply(ctx context.Context, flowSchema *flowcontrolv1beta1.FlowSchemaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.FlowSchema, err error) {
	if flowSchema == nil {
...
func (c *flowSchemasClusterClient) ApplyStatus(ctx context.Context, flowSchema *flowcontrolv1beta1.FlowSchemaApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.FlowSchema, err error) {
	if flowSchema == nil {
		return nil, fmt.Errorf("flowSchema provided to Apply must not be nil")
	}
	data, err := json.Marshal(flowSchema)
