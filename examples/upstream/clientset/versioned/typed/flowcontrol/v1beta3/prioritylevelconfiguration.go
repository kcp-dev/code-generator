...
type PriorityLevelConfigurationClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta3client.PriorityLevelConfigurationInterface
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1beta3client.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta3.PriorityLevelConfigurationList, error) {
