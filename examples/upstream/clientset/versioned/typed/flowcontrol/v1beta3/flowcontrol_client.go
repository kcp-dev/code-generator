...
type FlowcontrolV1beta3ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta3client.FlowcontrolV1beta3Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FlowcontrolV1beta3ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamflowcontrolv1beta3client.FlowcontrolV1beta3Client]{
		NewForConfigAndClient: upstreamflowcontrolv1beta3client.NewForConfigAndClient,
	})
