...
func (c *priorityLevelConfigurationsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(prioritylevelconfigurationsResource, c.ClusterPath, c.Namespace, name), &v1beta3.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityLevelConfigurationsClusterClient) Create(ctx context.Context, priorityLevelConfiguration *v1beta3.PriorityLevelConfiguration, opts v1.CreateOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
...
func (c *priorityLevelConfigurationsClusterClient) Update(ctx context.Context, priorityLevelConfiguration *v1beta3.PriorityLevelConfiguration, opts v1.UpdateOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
	emptyResult := &v1beta3.PriorityLevelConfiguration{}
	obj, err := c.Fake.
...
func (c *priorityLevelConfigurationsClusterClient) UpdateStatus(ctx context.Context, priorityLevelConfiguration *v1beta3.PriorityLevelConfiguration, opts v1.UpdateOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
	emptyResult := &v1beta3.PriorityLevelConfiguration{}
	obj, err := c.Fake.
...
func (c *priorityLevelConfigurationsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta3.PriorityLevelConfiguration, err error) {
	emptyResult := &v1beta3.PriorityLevelConfiguration{}
	obj, err := c.Fake.
...
func (c *priorityLevelConfigurationsClusterClient) Apply(ctx context.Context, priorityLevelConfiguration *flowcontrolv1beta3.PriorityLevelConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
...
func (c *priorityLevelConfigurationsClusterClient) ApplyStatus(ctx context.Context, priorityLevelConfiguration *flowcontrolv1beta3.PriorityLevelConfigurationApplyConfiguration, opts v1.ApplyOptions) (result *v1beta3.PriorityLevelConfiguration, err error) {
	if priorityLevelConfiguration == nil {
		return nil, fmt.Errorf("priorityLevelConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(priorityLevelConfiguration)
