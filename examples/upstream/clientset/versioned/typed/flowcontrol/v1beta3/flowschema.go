...
type FlowSchemaClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta3client.FlowSchemaInterface
	FlowSchemaExpansion
}
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1beta3client.FlowSchemaInterface {
...
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta3.FlowSchemaList, error) {
