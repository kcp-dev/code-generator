...
type PriorityLevelConfigurationClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1client.PriorityLevelConfigurationInterface
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1client.PriorityLevelConfigurationInterface {
