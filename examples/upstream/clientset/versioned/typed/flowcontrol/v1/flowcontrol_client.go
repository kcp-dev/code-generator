...
type FlowcontrolV1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamflowcontrolv1client.FlowcontrolV1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FlowcontrolV1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamflowcontrolv1client.FlowcontrolV1Client]{
		NewForConfigAndClient: upstreamflowcontrolv1client.NewForConfigAndClient,
	})
