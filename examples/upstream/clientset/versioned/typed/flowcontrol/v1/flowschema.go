...
type FlowSchemaClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1client.FlowSchemaInterface
	FlowSchemaExpansion
}
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1client.FlowSchemaInterface {
