...
type FlowcontrolV1beta2ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta2client.FlowcontrolV1beta2Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FlowcontrolV1beta2ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamflowcontrolv1beta2client.FlowcontrolV1beta2Client]{
		NewForConfigAndClient: upstreamflowcontrolv1beta2client.NewForConfigAndClient,
	})
