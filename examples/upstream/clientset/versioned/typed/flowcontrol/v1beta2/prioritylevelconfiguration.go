...
type PriorityLevelConfigurationClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta2client.PriorityLevelConfigurationInterface
...
func (c *priorityLevelConfigurationsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1beta2client.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta2.PriorityLevelConfigurationList, error) {
