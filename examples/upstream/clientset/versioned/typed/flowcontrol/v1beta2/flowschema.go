...
type FlowSchemaClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamflowcontrolv1beta2client.FlowSchemaInterface
	FlowSchemaExpansion
}
...
func (c *flowSchemasClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamflowcontrolv1beta2client.FlowSchemaInterface {
...
// List returns the entire collection of all FlowSchemas that are available in all clusters.
func (c *flowSchemasClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta2.FlowSchemaList, error) {
