...
type SchedulingV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamschedulingv1alpha1client.SchedulingV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SchedulingV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamschedulingv1alpha1client.SchedulingV1alpha1Client]{
		NewForConfigAndClient: upstreamschedulingv1alpha1client.NewForConfigAndClient,
	})
