...
func (c *priorityClassesClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PriorityClass, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(priorityclassesResource, c.ClusterPath, c.Namespace, name), &v1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityClassesClusterClient) Create(ctx context.Context, priorityClass *v1alpha1.PriorityClass, opts v1.CreateOptions) (result *v1alpha1.PriorityClass, err error) {
...
func (c *priorityClassesClusterClient) Update(ctx context.Context, priorityClass *v1alpha1.PriorityClass, opts v1.UpdateOptions) (result *v1alpha1.PriorityClass, err error) {
	emptyResult := &v1alpha1.PriorityClass{}
	obj, err := c.Fake.
...
func (c *priorityClassesClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PriorityClass, err error) {
	emptyResult := &v1alpha1.PriorityClass{}
	obj, err := c.Fake.
...
func (c *priorityClassesClusterClient) Apply(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClassApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PriorityClass, err error) {
