...
type PriorityClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamschedulingv1alpha1client.PriorityClassInterface
	PriorityClassExpansion
}

type priorityClassesClusterInterface struct {
	clientCache kcpclient.Cache[*upstreamschedulingv1alpha1client.SchedulingV1alpha1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *priorityClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamschedulingv1alpha1client.PriorityClassInterface {
...
func (c *priorityClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1alpha1.PriorityClassList, error) {
