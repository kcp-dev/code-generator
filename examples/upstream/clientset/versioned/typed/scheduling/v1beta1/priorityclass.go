...
type PriorityClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamschedulingv1beta1client.PriorityClassInterface
...
func (c *priorityClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamschedulingv1beta1client.PriorityClassInterface {
...
func (c *priorityClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.PriorityClassList, error) {
