...
type SchedulingV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamschedulingv1beta1client.SchedulingV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SchedulingV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamschedulingv1beta1client.SchedulingV1beta1Client]{
		NewForConfigAndClient: upstreamschedulingv1beta1client.NewForConfigAndClient,
	})
