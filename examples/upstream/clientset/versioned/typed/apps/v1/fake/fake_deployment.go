...
func (c *deploymentsClient) ApplyStatus(ctx context.Context, applyConfiguration *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*v1.Deployment, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(deploymentsResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1.Deployment{})
...
func (c *deploymentsClient) ApplyScale(ctx context.Context, deploymentName string, applyConfiguration *appsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
