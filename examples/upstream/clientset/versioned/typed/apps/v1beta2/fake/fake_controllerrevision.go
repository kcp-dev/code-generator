...
func (c *controllerRevisionsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.ControllerRevision, err error) {
...
func (c *controllerRevisionsClusterClient) Create(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, opts v1.CreateOptions) (result *v1beta2.ControllerRevision, err error) {
...
func (c *controllerRevisionsClusterClient) Update(ctx context.Context, controllerRevision *v1beta2.ControllerRevision, opts v1.UpdateOptions) (result *v1beta2.ControllerRevision, err error) {
	emptyResult := &v1beta2.ControllerRevision{}
	obj, err := c.Fake.
...
func (c *controllerRevisionsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.ControllerRevision, err error) {
	emptyResult := &v1beta2.ControllerRevision{}
	obj, err := c.Fake.
...
func (c *controllerRevisionsClusterClient) Apply(ctx context.Context, controllerRevision *appsv1beta2.ControllerRevisionApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.ControllerRevision, err error) {
