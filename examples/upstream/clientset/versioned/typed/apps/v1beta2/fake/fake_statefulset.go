...
func (c *statefulSetsClient) ApplyScale(ctx context.Context, deploymentName string, applyConfiguration *appsv1beta2.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
