...
func (c *daemonSetsClient) Update(ctx context.Context, daemonSet *v1beta2.DaemonSet, opts metav1.CreateOptions) (*v1beta2.DaemonSet, error) {
...
func (c *daemonSetsClient) UpdateStatus(ctx context.Context, daemonSet *v1beta2.DaemonSet, opts metav1.CreateOptions) (*v1beta2.DaemonSet, error) {
