...
func (c *deploymentsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.Deployment, err error) {
...
func (c *deploymentsClusterClient) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.DeploymentList, err error) {
...
func (c *deploymentsClusterClient) Create(ctx context.Context, deployment *v1beta2.Deployment, opts v1.CreateOptions) (result *v1beta2.Deployment, err error) {
...
func (c *deploymentsClusterClient) Update(ctx context.Context, deployment *v1beta2.Deployment, opts v1.UpdateOptions) (result *v1beta2.Deployment, err error) {
	emptyResult := &v1beta2.Deployment{}
	obj, err := c.Fake.
...
func (c *deploymentsClusterClient) UpdateStatus(ctx context.Context, deployment *v1beta2.Deployment, opts v1.UpdateOptions) (result *v1beta2.Deployment, err error) {
	emptyResult := &v1beta2.Deployment{}
	obj, err := c.Fake.
...
func (c *deploymentsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.Deployment, err error) {
	emptyResult := &v1beta2.Deployment{}
	obj, err := c.Fake.
...
func (c *deploymentsClusterClient) Apply(ctx context.Context, deployment *appsv1beta2.DeploymentApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.Deployment, err error) {
	if deployment == nil {
...
func (c *deploymentsClusterClient) ApplyStatus(ctx context.Context, deployment *appsv1beta2.DeploymentApplyConfiguration, opts v1.ApplyOptions) (result *v1beta2.Deployment, err error) {
	if deployment == nil {
		return nil, fmt.Errorf("deployment provided to Apply must not be nil")
	}
	data, err := json.Marshal(deployment)
