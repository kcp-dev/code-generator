...
func (c *deploymentsClusterClient) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.DeploymentList, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(deploymentsResource, deploymentsKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &v1beta2.DeploymentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *deploymentsClient) Update(ctx context.Context, deployment *v1beta2.Deployment, opts metav1.CreateOptions) (*v1beta2.Deployment, error) {
...
func (c *deploymentsClient) UpdateStatus(ctx context.Context, deployment *v1beta2.Deployment, opts metav1.CreateOptions) (*v1beta2.Deployment, error) {
...
func (c *deploymentsClient) Apply(ctx context.Context, applyConfiguration *appsv1beta2.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*v1beta2.Deployment, error) {
