...
func (c *daemonSetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta2.DaemonSetList, error) {
...
type DaemonSetNamespacer interface {
	Namespace(name string) upstreamappsv1beta2client.DaemonSetInterface
}
