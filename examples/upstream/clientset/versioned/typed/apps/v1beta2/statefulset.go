...
func (c *statefulSetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta2.StatefulSetList, error) {
...
type StatefulSetNamespacer interface {
	Namespace(name string) upstreamappsv1beta2client.StatefulSetInterface
}
