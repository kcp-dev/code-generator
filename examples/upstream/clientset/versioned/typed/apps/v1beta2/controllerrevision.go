...
func (c *controllerRevisionsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta2.ControllerRevisionList, error) {
...
type ControllerRevisionNamespacer interface {
	Namespace(name string) upstreamappsv1beta2client.ControllerRevisionInterface
}
