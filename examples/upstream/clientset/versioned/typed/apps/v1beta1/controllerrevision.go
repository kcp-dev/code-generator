...
func (c *controllerRevisionsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.ControllerRevisionList, error) {
...
type ControllerRevisionNamespacer interface {
	Namespace(name string) upstreamappsv1beta1client.ControllerRevisionInterface
}
