...
// StatefulSetClusterInterface has methods to work with StatefulSet resources.
type StatefulSetClusterInterface interface {
	...
	Cluster(logicalcluster.Path) StatefulSetNamespacer
...
func (c *statefulSetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.StatefulSetList, error) {
...
type StatefulSetNamespacer interface {
	Namespace(name string) upstreamappsv1beta1client.StatefulSetInterface
}
