...
func (c *resourceSlicesClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.ResourceSlice, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(resourceslicesResource, c.ClusterPath, c.Namespace, name), &v1alpha3.ResourceSlice{})
	if obj == nil {
		return nil, err
	}
...
func (c *resourceSlicesClusterClient) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *resourceSlicesClusterClient) Create(ctx context.Context, resourceSlice *v1alpha3.ResourceSlice, opts v1.CreateOptions) (result *v1alpha3.ResourceSlice, err error) {
...
func (c *resourceSlicesClusterClient) Update(ctx context.Context, resourceSlice *v1alpha3.ResourceSlice, opts v1.UpdateOptions) (result *v1alpha3.ResourceSlice, err error) {
	emptyResult := &v1alpha3.ResourceSlice{}
	obj, err := c.Fake.
...
func (c *resourceSlicesClusterClient) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *resourceSlicesClusterClient) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *resourceSlicesClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.ResourceSlice, err error) {
	emptyResult := &v1alpha3.ResourceSlice{}
	obj, err := c.Fake.
...
func (c *resourceSlicesClusterClient) Apply(ctx context.Context, resourceSlice *resourcev1alpha3.ResourceSliceApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha3.ResourceSlice, err error) {
