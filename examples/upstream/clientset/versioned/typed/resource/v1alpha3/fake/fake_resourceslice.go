...
func (c *resourceSlicesClusterClient) Cluster(clusterPath logicalcluster.Path) *kcp.ResourceSliceNamespacer {
	if clusterPath == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}

	return &resourceSlicesNamespacer{Fake: c.Fake, ClusterPath: clusterPath}
}
