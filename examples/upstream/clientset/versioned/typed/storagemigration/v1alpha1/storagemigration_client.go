...
type StoragemigrationV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamstoragemigrationv1alpha1client.StoragemigrationV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*StoragemigrationV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamstoragemigrationv1alpha1client.StoragemigrationV1alpha1Client]{
		NewForConfigAndClient: upstreamstoragemigrationv1alpha1client.NewForConfigAndClient,
	})
