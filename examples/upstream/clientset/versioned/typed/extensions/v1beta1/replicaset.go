...
func (c *replicaSetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.ReplicaSetList, error) {
...
type ReplicaSetNamespacer interface {
	Namespace(name string) upstreamextensionsv1beta1client.ReplicaSetInterface
}
