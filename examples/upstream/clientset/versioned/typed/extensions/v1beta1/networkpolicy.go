...
func (c *networkPoliciesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.NetworkPolicyList, error) {
...
type NetworkPolicyNamespacer interface {
	Namespace(name string) upstreamextensionsv1beta1client.NetworkPolicyInterface
}
