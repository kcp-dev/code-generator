...
func (c *certificateSigningRequestsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CertificateSigningRequest, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(certificatesigningrequestsResource, c.ClusterPath, c.Namespace, name), &v1beta1.CertificateSigningRequest{})
	if obj == nil {
		return nil, err
	}
...
func (c *certificateSigningRequestsClusterClient) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *certificateSigningRequestsClusterClient) Create(ctx context.Context, certificateSigningRequest *v1beta1.CertificateSigningRequest, opts v1.CreateOptions) (result *v1beta1.CertificateSigningRequest, err error) {
...
func (c *certificateSigningRequestsClusterClient) Update(ctx context.Context, certificateSigningRequest *v1beta1.CertificateSigningRequest, opts v1.UpdateOptions) (result *v1beta1.CertificateSigningRequest, err error) {
	emptyResult := &v1beta1.CertificateSigningRequest{}
	obj, err := c.Fake.
...
func (c *certificateSigningRequestsClusterClient) UpdateStatus(ctx context.Context, certificateSigningRequest *v1beta1.CertificateSigningRequest, opts v1.UpdateOptions) (result *v1beta1.CertificateSigningRequest, err error) {
	emptyResult := &v1beta1.CertificateSigningRequest{}
	obj, err := c.Fake.
...
func (c *certificateSigningRequestsClusterClient) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *certificateSigningRequestsClusterClient) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *certificateSigningRequestsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CertificateSigningRequest, err error) {
	emptyResult := &v1beta1.CertificateSigningRequest{}
	obj, err := c.Fake.
...
func (c *certificateSigningRequestsClusterClient) Apply(ctx context.Context, certificateSigningRequest *certificatesv1beta1.CertificateSigningRequestApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.CertificateSigningRequest, err error) {
...
func (c *certificateSigningRequestsClusterClient) ApplyStatus(ctx context.Context, certificateSigningRequest *certificatesv1beta1.CertificateSigningRequestApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.CertificateSigningRequest, err error) {
	if certificateSigningRequest == nil {
		return nil, fmt.Errorf("certificateSigningRequest provided to Apply must not be nil")
	}
	data, err := json.Marshal(certificateSigningRequest)
