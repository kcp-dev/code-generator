...
type CertificateSigningRequestClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamcertificatesv1beta1client.CertificateSigningRequestInterface
...
func (c *certificateSigningRequestsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamcertificatesv1beta1client.CertificateSigningRequestInterface {
...
func (c *certificateSigningRequestsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.CertificateSigningRequestList, error) {
