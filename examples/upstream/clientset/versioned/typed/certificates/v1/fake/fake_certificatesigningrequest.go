...
import (
	...
	kcp "k8s.io/code-generator/examples/upstream/clientset/versioned/typed/certificates/v1"
)
...
func (c *certificateSigningRequestsClusterClient) Cluster(clusterPath logicalcluster.Path) *kcp.CertificateSigningRequestNamespacer {
	if clusterPath == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}

	return &certificateSigningRequestsNamespacer{Fake: c.Fake, ClusterPath: clusterPath}
}
