...
type CertificatesV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamcertificatesv1alpha1client.CertificatesV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CertificatesV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamcertificatesv1alpha1client.CertificatesV1alpha1Client]{
		NewForConfigAndClient: upstreamcertificatesv1alpha1client.NewForConfigAndClient,
	})
