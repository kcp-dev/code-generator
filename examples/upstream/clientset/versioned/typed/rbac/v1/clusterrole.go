...
type ClusterRoleClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamrbacv1client.ClusterRoleInterface
...
func (c *clusterRolesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamrbacv1client.ClusterRoleInterface {
