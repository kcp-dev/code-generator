...
func (c *roleBindingsClient) ApplyStatus(ctx context.Context, applyConfiguration *rbacv1.RoleBindingApplyConfiguration, opts metav1.ApplyOptions) (*v1.RoleBinding, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolebindingsResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1.RoleBinding{})
