...
type RbacV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamrbacv1alpha1client.RbacV1alpha1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RbacV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamrbacv1alpha1client.RbacV1alpha1Client]{
		NewForConfigAndClient: upstreamrbacv1alpha1client.NewForConfigAndClient,
	})
