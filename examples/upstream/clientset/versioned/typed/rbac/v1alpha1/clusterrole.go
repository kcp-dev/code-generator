...
type ClusterRoleClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamrbacv1alpha1client.ClusterRoleInterface
...
func (c *clusterRolesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamrbacv1alpha1client.ClusterRoleInterface {
...
func (c *clusterRolesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1alpha1.ClusterRoleList, error) {
