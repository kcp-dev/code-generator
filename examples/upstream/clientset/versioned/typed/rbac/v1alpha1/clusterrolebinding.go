...
// ClusterRoleBindingClusterInterface has methods to work with ClusterRoleBinding resources.
type ClusterRoleBindingClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamrbacv1alpha1client.ClusterRoleBindingInterface
...
func (c *clusterRoleBindingsClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamrbacv1alpha1client.ClusterRoleBindingInterface {
...
func (c *clusterRoleBindingsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1alpha1.ClusterRoleBindingList, error) {
