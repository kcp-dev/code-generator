...
func (c *roleBindingsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RoleBinding, err error) {
...
func (c *roleBindingsClusterClient) Create(ctx context.Context, roleBinding *v1alpha1.RoleBinding, opts v1.CreateOptions) (result *v1alpha1.RoleBinding, err error) {
...
func (c *roleBindingsClusterClient) Update(ctx context.Context, roleBinding *v1alpha1.RoleBinding, opts v1.UpdateOptions) (result *v1alpha1.RoleBinding, err error) {
	emptyResult := &v1alpha1.RoleBinding{}
	obj, err := c.Fake.
...
func (c *roleBindingsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RoleBinding, err error) {
	emptyResult := &v1alpha1.RoleBinding{}
	obj, err := c.Fake.
...
func (c *roleBindingsClusterClient) Apply(ctx context.Context, roleBinding *rbacv1alpha1.RoleBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.RoleBinding, err error) {
	if roleBinding == nil {
