...
func (c *rolesClusterClient) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.RoleList, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(rolesResource, rolesKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &v1beta1.RoleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *rolesClient) Create(ctx context.Context, role *v1beta1.Role, opts metav1.CreateOptions) (*v1beta1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(rolesResource, c.ClusterPath, c.Namespace, role), &v1beta1.Role{})
...
func (c *rolesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*v1beta1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(rolesResource, c.ClusterPath, c.Namespace, name), &v1beta1.Role{})
...
func (c *rolesClient) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.RoleList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(rolesResource, rolesKind, c.ClusterPath, c.Namespace, opts), &v1beta1.RoleList{})
...
func (c *rolesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*v1beta1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.ClusterPath, c.Namespace, name, pt, data, subresources...), &v1beta1.Role{})
...
func (c *rolesClient) Apply(ctx context.Context, applyConfiguration *rbacv1beta1.RoleApplyConfiguration, opts metav1.ApplyOptions) (*v1beta1.Role, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data), &v1beta1.Role{})
...
func (c *rolesClient) ApplyStatus(ctx context.Context, applyConfiguration *rbacv1beta1.RoleApplyConfiguration, opts metav1.ApplyOptions) (*v1beta1.Role, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1beta1.Role{})
