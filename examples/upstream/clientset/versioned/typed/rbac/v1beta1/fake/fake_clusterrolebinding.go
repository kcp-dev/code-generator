...
func (c *clusterRoleBindingsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ClusterRoleBinding, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(clusterrolebindingsResource, c.ClusterPath, c.Namespace, name), &v1beta1.ClusterRoleBinding{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterRoleBindingsClusterClient) Create(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, opts v1.CreateOptions) (result *v1beta1.ClusterRoleBinding, err error) {
...
func (c *clusterRoleBindingsClusterClient) Update(ctx context.Context, clusterRoleBinding *v1beta1.ClusterRoleBinding, opts v1.UpdateOptions) (result *v1beta1.ClusterRoleBinding, err error) {
	emptyResult := &v1beta1.ClusterRoleBinding{}
	obj, err := c.Fake.
...
func (c *clusterRoleBindingsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ClusterRoleBinding, err error) {
	emptyResult := &v1beta1.ClusterRoleBinding{}
	obj, err := c.Fake.
...
func (c *clusterRoleBindingsClusterClient) Apply(ctx context.Context, clusterRoleBinding *rbacv1beta1.ClusterRoleBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ClusterRoleBinding, err error) {
