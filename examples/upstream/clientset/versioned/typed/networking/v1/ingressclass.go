...
type IngressClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamnetworkingv1client.IngressClassInterface
...
func (c *ingressClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamnetworkingv1client.IngressClassInterface {
