...
func (c *ingressesClusterClient) List(ctx context.Context, opts metav1.ListOptions) (result *v1.IngressList, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(ingressesResource, ingressesKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &v1.IngressList{})
	if obj == nil {
		return nil, err
	}
...
func (c *ingressesClient) Create(ctx context.Context, ingress *v1.Ingress, opts metav1.CreateOptions) (*v1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(ingressesResource, c.ClusterPath, c.Namespace, ingress), &v1.Ingress{})
...
func (c *ingressesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*v1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(ingressesResource, c.ClusterPath, c.Namespace, name), &v1.Ingress{})
...
func (c *ingressesClient) List(ctx context.Context, opts metav1.ListOptions) (*v1.IngressList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(ingressesResource, ingressesKind, c.ClusterPath, c.Namespace, opts), &v1.IngressList{})
...
func (c *ingressesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*v1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.ClusterPath, c.Namespace, name, pt, data, subresources...), &v1.Ingress{})
...
func (c *ingressesClient) Apply(ctx context.Context, applyConfiguration *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*v1.Ingress, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data), &v1.Ingress{})
...
func (c *ingressesClient) ApplyStatus(ctx context.Context, applyConfiguration *networkingv1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*v1.Ingress, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1.Ingress{})
