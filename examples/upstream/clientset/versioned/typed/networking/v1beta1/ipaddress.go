...
type IPAddressClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamnetworkingv1beta1client.IPAddressInterface
	IPAddressExpansion
}
...
func (c *iPAddressesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamnetworkingv1beta1client.IPAddressInterface {
...
func (c *iPAddressesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.IPAddressList, error) {
