...
func (c *serviceCIDRsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ServiceCIDR, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(servicecidrsResource, c.ClusterPath, c.Namespace, name), &v1beta1.ServiceCIDR{})
	if obj == nil {
		return nil, err
	}
...
func (c *serviceCIDRsClusterClient) Create(ctx context.Context, serviceCIDR *v1beta1.ServiceCIDR, opts v1.CreateOptions) (result *v1beta1.ServiceCIDR, err error) {
...
func (c *serviceCIDRsClusterClient) Update(ctx context.Context, serviceCIDR *v1beta1.ServiceCIDR, opts v1.UpdateOptions) (result *v1beta1.ServiceCIDR, err error) {
	emptyResult := &v1beta1.ServiceCIDR{}
	obj, err := c.Fake.
...
func (c *serviceCIDRsClusterClient) UpdateStatus(ctx context.Context, serviceCIDR *v1beta1.ServiceCIDR, opts v1.UpdateOptions) (result *v1beta1.ServiceCIDR, err error) {
	emptyResult := &v1beta1.ServiceCIDR{}
	obj, err := c.Fake.
...
func (c *serviceCIDRsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ServiceCIDR, err error) {
	emptyResult := &v1beta1.ServiceCIDR{}
	obj, err := c.Fake.
...
func (c *serviceCIDRsClusterClient) Apply(ctx context.Context, serviceCIDR *networkingv1beta1.ServiceCIDRApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ServiceCIDR, err error) {
	if serviceCIDR == nil {
...
func (c *serviceCIDRsClusterClient) ApplyStatus(ctx context.Context, serviceCIDR *networkingv1beta1.ServiceCIDRApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.ServiceCIDR, err error) {
	if serviceCIDR == nil {
		return nil, fmt.Errorf("serviceCIDR provided to Apply must not be nil")
	}
	data, err := json.Marshal(serviceCIDR)
