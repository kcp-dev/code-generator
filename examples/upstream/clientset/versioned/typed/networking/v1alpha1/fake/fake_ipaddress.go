...
func (c *iPAddressesClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IPAddress, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(ipaddressesResource, c.ClusterPath, c.Namespace, name), &v1alpha1.IPAddress{})
	if obj == nil {
		return nil, err
	}
...
func (c *iPAddressesClusterClient) Create(ctx context.Context, iPAddress *v1alpha1.IPAddress, opts v1.CreateOptions) (result *v1alpha1.IPAddress, err error) {
...
func (c *iPAddressesClusterClient) Update(ctx context.Context, iPAddress *v1alpha1.IPAddress, opts v1.UpdateOptions) (result *v1alpha1.IPAddress, err error) {
	emptyResult := &v1alpha1.IPAddress{}
	obj, err := c.Fake.
...
func (c *iPAddressesClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IPAddress, err error) {
	emptyResult := &v1alpha1.IPAddress{}
	obj, err := c.Fake.
...
func (c *iPAddressesClusterClient) Apply(ctx context.Context, iPAddress *networkingv1alpha1.IPAddressApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.IPAddress, err error) {
	if iPAddress == nil {
