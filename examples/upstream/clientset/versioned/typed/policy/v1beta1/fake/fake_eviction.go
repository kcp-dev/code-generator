...
func (c *evictionsClient) ApplyStatus(ctx context.Context, applyConfiguration *policyv1beta1.EvictionApplyConfiguration, opts metav1.ApplyOptions) (*v1beta1.Eviction, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(evictionsResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1beta1.Eviction{})
