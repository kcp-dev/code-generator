...
type PolicyV1beta1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreampolicyv1beta1client.PolicyV1beta1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*PolicyV1beta1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreampolicyv1beta1client.PolicyV1beta1Client]{
		NewForConfigAndClient: upstreampolicyv1beta1client.NewForConfigAndClient,
	})
