...
func (c *evictionsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.EvictionList, error) {
...
type EvictionNamespacer interface {
	Namespace(name string) upstreampolicyv1beta1client.EvictionInterface
}
