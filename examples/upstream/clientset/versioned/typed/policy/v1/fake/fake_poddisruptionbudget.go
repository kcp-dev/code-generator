...
func (c *podDisruptionBudgetsClusterClient) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.PodDisruptionBudget, err error) {
...
func (c *podDisruptionBudgetsClusterClient) Create(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts metav1.CreateOptions) (result *v1.PodDisruptionBudget, err error) {
...
func (c *podDisruptionBudgetsClusterClient) Update(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts metav1.UpdateOptions) (result *v1.PodDisruptionBudget, err error) {
	emptyResult := &v1.PodDisruptionBudget{}
	obj, err := c.Fake.
...
func (c *podDisruptionBudgetsClusterClient) UpdateStatus(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts metav1.UpdateOptions) (result *v1.PodDisruptionBudget, err error) {
	emptyResult := &v1.PodDisruptionBudget{}
	obj, err := c.Fake.
...
func (c *podDisruptionBudgetsClusterClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *podDisruptionBudgetsClusterClient) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
...
func (c *podDisruptionBudgetsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.PodDisruptionBudget, err error) {
	emptyResult := &v1.PodDisruptionBudget{}
	obj, err := c.Fake.
...
func (c *podDisruptionBudgetsClusterClient) Apply(ctx context.Context, podDisruptionBudget *policyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (result *v1.PodDisruptionBudget, err error) {
...
func (c *podDisruptionBudgetsClusterClient) ApplyStatus(ctx context.Context, podDisruptionBudget *policyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (result *v1.PodDisruptionBudget, err error) {
	if podDisruptionBudget == nil {
		return nil, fmt.Errorf("podDisruptionBudget provided to Apply must not be nil")
	}
	data, err := json.Marshal(podDisruptionBudget)
