...
func (c *podDisruptionBudgetsClusterClient) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PodDisruptionBudgetList, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(poddisruptionbudgetsResource, poddisruptionbudgetsKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &v1.PodDisruptionBudgetList{})
	if obj == nil {
		return nil, err
	}
...
func (c *podDisruptionBudgetsClient) Create(ctx context.Context, podDisruptionBudget *v1.PodDisruptionBudget, opts metav1.CreateOptions) (*v1.PodDisruptionBudget, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(poddisruptionbudgetsResource, c.ClusterPath, c.Namespace, podDisruptionBudget), &v1.PodDisruptionBudget{})
...
func (c *podDisruptionBudgetsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*v1.PodDisruptionBudget, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(poddisruptionbudgetsResource, c.ClusterPath, c.Namespace, name), &v1.PodDisruptionBudget{})
...
func (c *podDisruptionBudgetsClient) List(ctx context.Context, opts metav1.ListOptions) (*v1.PodDisruptionBudgetList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(poddisruptionbudgetsResource, poddisruptionbudgetsKind, c.ClusterPath, c.Namespace, opts), &v1.PodDisruptionBudgetList{})
...
func (c *podDisruptionBudgetsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*v1.PodDisruptionBudget, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(poddisruptionbudgetsResource, c.ClusterPath, c.Namespace, name, pt, data, subresources...), &v1.PodDisruptionBudget{})
...
func (c *podDisruptionBudgetsClient) Apply(ctx context.Context, applyConfiguration *policyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (*v1.PodDisruptionBudget, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(poddisruptionbudgetsResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data), &v1.PodDisruptionBudget{})
...
func (c *podDisruptionBudgetsClient) ApplyStatus(ctx context.Context, applyConfiguration *policyv1.PodDisruptionBudgetApplyConfiguration, opts metav1.ApplyOptions) (*v1.PodDisruptionBudget, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(poddisruptionbudgetsResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1.PodDisruptionBudget{})
