...
func (c *evictionsClient) Update(ctx context.Context, eviction *v1.Eviction, opts metav1.CreateOptions) (*v1.Eviction, error) {
...
func (c *evictionsClient) UpdateStatus(ctx context.Context, eviction *v1.Eviction, opts metav1.CreateOptions) (*v1.Eviction, error) {
