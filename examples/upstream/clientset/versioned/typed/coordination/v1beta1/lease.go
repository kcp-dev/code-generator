...
func (c *leasesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.LeaseList, error) {
...
type LeaseNamespacer interface {
	Namespace(name string) upstreamcoordinationv1beta1client.LeaseInterface
}
