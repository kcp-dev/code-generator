...
type CoordinationV1ClusterScoper interface {
	Cluster(logicalcluster.Path) upstreamcoordinationv1client.CoordinationV1Interface
}
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CoordinationV1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*upstreamcoordinationv1client.CoordinationV1Client]{
		NewForConfigAndClient: upstreamcoordinationv1client.NewForConfigAndClient,
	})
