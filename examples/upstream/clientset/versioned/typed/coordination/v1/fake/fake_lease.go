...
func (c *leasesClient) Update(ctx context.Context, lease *v1.Lease, opts metav1.CreateOptions) (*v1.Lease, error) {
...
func (c *leasesClient) UpdateStatus(ctx context.Context, lease *v1.Lease, opts metav1.CreateOptions) (*v1.Lease, error) {
...
// List takes label and field selectors, and returns the list of v1.Lease that match those selectors.
