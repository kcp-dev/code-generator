...
func (c *volumeAttachmentsClusterClient) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VolumeAttachment, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(volumeattachmentsResource, c.ClusterPath, c.Namespace, name), &v1beta1.VolumeAttachment{})
	if obj == nil {
		return nil, err
	}
...
func (c *volumeAttachmentsClusterClient) Create(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, opts v1.CreateOptions) (result *v1beta1.VolumeAttachment, err error) {
...
func (c *volumeAttachmentsClusterClient) Update(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, opts v1.UpdateOptions) (result *v1beta1.VolumeAttachment, err error) {
	emptyResult := &v1beta1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) UpdateStatus(ctx context.Context, volumeAttachment *v1beta1.VolumeAttachment, opts v1.UpdateOptions) (result *v1beta1.VolumeAttachment, err error) {
	emptyResult := &v1beta1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeAttachment, err error) {
	emptyResult := &v1beta1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) Apply(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error) {
...
func (c *volumeAttachmentsClusterClient) ApplyStatus(ctx context.Context, volumeAttachment *storagev1beta1.VolumeAttachmentApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.VolumeAttachment, err error) {
	if volumeAttachment == nil {
		return nil, fmt.Errorf("volumeAttachment provided to Apply must not be nil")
	}
	data, err := json.Marshal(volumeAttachment)
