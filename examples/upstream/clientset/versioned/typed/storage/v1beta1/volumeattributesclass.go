...
type VolumeAttributesClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1beta1client.VolumeAttributesClassInterface
...
func (c *volumeAttributesClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1beta1client.VolumeAttributesClassInterface {
...
func (c *volumeAttributesClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.VolumeAttributesClassList, error) {
