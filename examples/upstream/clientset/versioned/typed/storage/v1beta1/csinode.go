...
type CSINodeClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1beta1client.CSINodeInterface
	CSINodeExpansion
}
...
func (c *cSINodesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1beta1client.CSINodeInterface {
...
// List returns the entire collection of all CSINodes that are available in all clusters.
func (c *cSINodesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1beta1.CSINodeList, error) {
