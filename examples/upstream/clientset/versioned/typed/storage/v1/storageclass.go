...
type StorageClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1client.StorageClassInterface
...
func (c *storageClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1client.StorageClassInterface {
