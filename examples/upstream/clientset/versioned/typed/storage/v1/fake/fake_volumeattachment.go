...
func (c *volumeAttachmentsClusterClient) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.VolumeAttachment, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(volumeattachmentsResource, c.ClusterPath, c.Namespace, name), &v1.VolumeAttachment{})
	if obj == nil {
		return nil, err
	}
...
func (c *volumeAttachmentsClusterClient) Create(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts metav1.CreateOptions) (result *v1.VolumeAttachment, err error) {
...
func (c *volumeAttachmentsClusterClient) Update(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts metav1.UpdateOptions) (result *v1.VolumeAttachment, err error) {
	emptyResult := &v1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) UpdateStatus(ctx context.Context, volumeAttachment *v1.VolumeAttachment, opts metav1.UpdateOptions) (result *v1.VolumeAttachment, err error) {
	emptyResult := &v1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
...
func (c *volumeAttachmentsClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.VolumeAttachment, err error) {
	emptyResult := &v1.VolumeAttachment{}
	obj, err := c.Fake.
...
func (c *volumeAttachmentsClusterClient) Apply(ctx context.Context, volumeAttachment *storagev1.VolumeAttachmentApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VolumeAttachment, err error) {
...
func (c *volumeAttachmentsClusterClient) ApplyStatus(ctx context.Context, volumeAttachment *storagev1.VolumeAttachmentApplyConfiguration, opts metav1.ApplyOptions) (result *v1.VolumeAttachment, err error) {
	if volumeAttachment == nil {
		return nil, fmt.Errorf("volumeAttachment provided to Apply must not be nil")
	}
	data, err := json.Marshal(volumeAttachment)
