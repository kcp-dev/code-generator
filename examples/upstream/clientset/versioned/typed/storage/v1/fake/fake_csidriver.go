...
func (c *cSIDriversClusterClient) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CSIDriver, err error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(csidriversResource, c.ClusterPath, c.Namespace, name), &v1.CSIDriver{})
	if obj == nil {
		return nil, err
	}
...
func (c *cSIDriversClusterClient) Create(ctx context.Context, cSIDriver *v1.CSIDriver, opts metav1.CreateOptions) (result *v1.CSIDriver, err error) {
...
func (c *cSIDriversClusterClient) Update(ctx context.Context, cSIDriver *v1.CSIDriver, opts metav1.UpdateOptions) (result *v1.CSIDriver, err error) {
	emptyResult := &v1.CSIDriver{}
	obj, err := c.Fake.
...
func (c *cSIDriversClusterClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *cSIDriversClusterClient) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
...
func (c *cSIDriversClusterClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CSIDriver, err error) {
	emptyResult := &v1.CSIDriver{}
	obj, err := c.Fake.
...
func (c *cSIDriversClusterClient) Apply(ctx context.Context, cSIDriver *storagev1.CSIDriverApplyConfiguration, opts metav1.ApplyOptions) (result *v1.CSIDriver, err error) {
	if cSIDriver == nil {
