...
func (c *cSIStorageCapacitiesClient) ApplyStatus(ctx context.Context, applyConfiguration *storagev1.CSIStorageCapacityApplyConfiguration, opts metav1.ApplyOptions) (*v1.CSIStorageCapacity, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(csistoragecapacitiesResource, c.ClusterPath, c.Namespace, *name, types.ApplyPatchType, data, "status"), &v1.CSIStorageCapacity{})
