...
type CSINodeClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1client.CSINodeInterface
	CSINodeExpansion
}
...
func (c *cSINodesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1client.CSINodeInterface {
