...
type CSIDriverClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1client.CSIDriverInterface
	CSIDriverExpansion
}
...
func (c *cSIDriversClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1client.CSIDriverInterface {
