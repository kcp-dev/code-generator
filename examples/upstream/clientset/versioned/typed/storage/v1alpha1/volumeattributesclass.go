...
// VolumeAttributesClassClusterInterface has methods to work with VolumeAttributesClass resources.
type VolumeAttributesClassClusterInterface interface {
	...
	Cluster(logicalcluster.Path) upstreamstoragev1alpha1client.VolumeAttributesClassInterface
...
func (c *volumeAttributesClassesClusterInterface) Cluster(clusterPath logicalcluster.Path) upstreamstoragev1alpha1client.VolumeAttributesClassInterface {
...
// List returns the entire collection of all VolumeAttributesClasses that are available in all clusters.
func (c *volumeAttributesClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1alpha1.VolumeAttributesClassList, error) {
