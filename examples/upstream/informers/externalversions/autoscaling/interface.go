...
import (
	v1 "k8s.io/code-generator/examples/upstream/informers/externalversions/autoscaling/v1"
	v2 "k8s.io/code-generator/examples/upstream/informers/externalversions/autoscaling/v2"
	v2beta1 "k8s.io/code-generator/examples/upstream/informers/externalversions/autoscaling/v2beta1"
	v2beta2 "k8s.io/code-generator/examples/upstream/informers/externalversions/autoscaling/v2beta2"
