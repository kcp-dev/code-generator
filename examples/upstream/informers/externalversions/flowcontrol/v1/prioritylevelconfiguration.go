...
import (
	upstreamflowcontrol.apiserver.k8s.iov1informers "k8s.io/client-go/informers/v1/flowcontrol.apiserver.k8s.io"
...
type PriorityLevelConfigurationClusterInformer interface {
	...
	Cluster(logicalcluster.Name) upstreamflowcontrol.apiserver.k8s.iov1informers.PriorityLevelConfigurationInformer
}
