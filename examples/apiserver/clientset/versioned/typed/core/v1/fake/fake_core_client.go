...
func (c *CoreV1ClusterClient) Cluster(clusterPath logicalcluster.Path) CoreV1Client {
...
func (c *CoreV1ClusterClient) TestTypes(namespace string) v1.TestTypeClusterInterface {
...
func (c *CoreV1Client) TestTypes(namespace string) CoreV1Client {
