...
import (
	...
	kcp "k8s.io/code-generator/examples/apiserver/clientset/versioned/typed/core/v1"
)
...
func (n *testTypesNamespacer) Namespace(namespace string) upstreamcorev1client.TestTypeInterface {
