...
import (
	...
	kcp "k8s.io/code-generator/examples/apiserver/clientset/versioned/typed/example3.io/v1"
)
...
func (n *testTypesNamespacer) Namespace(namespace string) upstreamthirdexamplev1client.TestTypeInterface {
